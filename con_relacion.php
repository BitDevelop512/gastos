...
if (is_ajax())
{
  ...
  $query = "SELECT conse, tipo FROM cx_rel_gas WHERE mision='$var3' AND ordop='$ordop' AND n_ordop='$var1' AND numero='$var5' AND consecu='$var4' AND unidad='$uni_usuario' AND ((usuario='$usu_usuario') OR (usuario='$log_usuario')) AND ano='$ano'";
