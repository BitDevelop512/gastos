...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Factura Bienes <?php echo $sigla; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/bienes/".$sigla."/".$alea."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload7.php?alea=<?php echo $alea; ?>&sigla=<?php echo $sigla; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
