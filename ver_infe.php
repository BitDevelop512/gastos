...
else
{
	...
	$carpeta = $ruta_local."\\fpdf\\pdf\\Ejecutivos";
	...
	$carpeta2 = $url."fpdf/pdf/Ejecutivos/".$ano;
	// Archivo
	$archivo = "InfEje_".trim($sig_usuario)."_".$conse."_".$ano.".pdf";
	$ruta = "fpdf/pdf/Ejecutivos/".$ano."/".$archivo;
	// Se valida fecha de formato
	$query = "SELECT fecha FROM cx_inf_eje WHERE conse='$conse' AND interno='$interno' AND ano='$ano'";
	...
	{
		$pdf = "./fpdf/632.php?conse=".$conse."&ano=".$ano;
	}
?>
<html lang="es">
	<head>
