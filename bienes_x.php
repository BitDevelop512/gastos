...
$objPHPExcel->getActiveSheet()->getStyle('A1:BL1')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
$objPHPExcel->getActiveSheet()->getStyle('A1:BL1')->getFill()->getStartColor()->setARGB('CCCCCC');
...
$objPHPExcel->getActiveSheet()->getStyle('A1:BL5')->applyFromArray($BStyle);
$objPHPExcel->setActiveSheetIndex(0)
    ...
    ->setCellValue('BK1', 'Usuario Registra')
    ->setCellValue('BL1', 'Fecha Registra');
$j=2;
for ($i=0;$i<count($paso1)-1;++$i)
{
    ...
    $v63 = $paso2[61];
    $v64 = $paso2[62];
    $objPHPExcel->getActiveSheet()->getStyle('H'.$j.':H'.$j)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
    $objPHPExcel->getActiveSheet()->getStyle('W'.$j.':W'.$j)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
    $objPHPExcel->getActiveSheet()->getStyle('Y'.$j.':Y'.$j)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
    $objPHPExcel->getActiveSheet()->getStyle('A'.$j.':BL'.$j)->applyFromArray($BStyle);
    $objPHPExcel->setActiveSheetIndex(0)
        ->setCellValue('A'.$j, $v1)
        ->setCellValue('B'.$j, $v2)
        ->setCellValue('C'.$j, $v3)
        ...
        ->setCellValue('BK'.$j, $v63)
        ->setCellValue('BL'.$j, $v64);
    $j++;
}
