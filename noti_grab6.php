...
if (is_ajax())
{
	...
	$mensaje = "SE HA APROBADO Y VERIFICADO EL REGISTRO DE RECOMPENSA CON EL INTERNO ".$valor2.". SE SOLICITA EVALUACION DEL MISMO.";
	...
	$graba = "UPDATE cx_reg_rec SET estado='A', usuario2='$valor', fec_sol1=getdate() WHERE conse='$valor2'";
