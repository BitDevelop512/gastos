...
else
{
	...
	$conse = $_GET['conse'];
  $ano = $_GET['ano'];
  $query = "SELECT unidad, periodo, ano, tipo, estado, usuario, recursos, actual, especial, usuario1 FROM cx_pla_inv WHERE conse='$conse' AND ano='$ano' AND unidad!='999' ORDER BY conse, ano";
  ...
  $val_usuario = trim(odbc_result($sql,10));
	if ($tipo == "1")
  {
   	if ($adm_usuario == "3")
   	{
      ...
      <tr>
        <td>
          <div id="div5">
            ...
            <input type="text" name="responsable" id="responsable" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="100" onkeypress="return check8(event);" autocomplete="off">
          </div>
        </td>
      </tr>
    </table>
    ...
    else
    {
      ...
      if (val_tip == "2")
      {
        ...
        else
        {
          ...
          {
            if ((valida1 == "B") && (nunidad == "1") && (admin == "16"))
            {
              $("#div3").show();
            }
            else
...
function graba()
{
  ...
  {
    if ((valida1 == "A") || (valida1 == "C") || (valida1 == "M") || (valida1 == "N") || (valida1 == "U"))
    {
    }
    else
    {
  ...
  if ($("#tipo").val() == '2')
  {
    ...
    else
    {
      ...
      if (est_fin == 'P')
      {
        ...
        {
          salida = false;
          alerta("Debe ingresar el Responsable");
        }
      }
    }
  }
...
// 14/09/2023 - Ajuste inclusion de iva total
// 04/04/2024 - Ajuste bloqueo pegado en campo responsable
...
// 07/11/2024 - Ajuste modificacion valor de pago de informaciones
// 10/12/2024 - Ajuste campo responsable caracteres especiales
// 03/03/2025 - Ajuste criterios de evaluacion
?>