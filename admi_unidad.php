          ...
          <div>
            ...
            <form name="formu" method="post">
              ...
              <div class="row">
                ...
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <input type="text" name="filtro" id="filtro" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onblur="trae_bat1();" maxlength="50" autocomplete="off">
                </div>
              </div>
              <div id="espacio1"></div>
              <div id="tabla4"></div>
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      $.each(registros.rows, function (index, value)
      {
        ...
        salida2 += "<td width='5%' height='35'><center><a href='#' onclick='actu("+value.subdependencia+")'><img src='imagenes/editar.png' width='24' height='24' border='0' title='Modificar'></a></center></td></tr>";
      });
      salida2 += "</table>";
...
// 03/07/2024 - Ajuste y grabación cambio de division o brigada
?>