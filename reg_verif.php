  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      $.each(registros.rows, function (index, value)
      {
        ...
        v_var1 += value.conse+"|"+value.fecha+"|"+value.unidad1+"|"+value.n_dependencia+"|"+value.valor+"|"+value.dias+"|"+value.ordop+"|"+value.fragmenta+"|"+value.n_estado+"|"+valida4+"|"+value.cedulas+"|#";
        listareg.push(index);
      });
      salida2 += "</table>";
