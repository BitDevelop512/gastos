...
else
{
	...
	{
		$fpdf = "fpdf";
		$pdf = "./".$fpdf."/640_1.php?conse=".$conse."&ano=".$ano."&tipo=".$tipo."&periodo=".$periodo."&unidad=".$unidad;
	}
	else
	{
		$fpdf = "fpdf1";
		if ($tipo == "1")
		{
			$pdf = "./".$fpdf."/640.php?conse=".$conse."&ano=".$ano."&tipo=".$tipo."&periodo=".$periodo."&unidad=".$unidad;
		}
		else
		{
			$pdf = "./".$fpdf."/629.php?conse=".$conse."&ano=".$ano."&tipo=".$tipo."&periodo=".$periodo."&unidad=".$unidad;
		}
	}
	// Permiso de Descarga
	$valor4 = "1";
