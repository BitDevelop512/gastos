...
if (is_ajax())
{
	...
	else
	{
		...
		$consecu = $consecu+1;
		// Se graba acta
		$graba = "INSERT INTO cx_act_inf (conse, usuario, unidad, ciudad, fuente, testigo, valor, utilidad, sintesis, difusion, unidad1, num_dif, fec_dif, pys, ano, firmas, pla_inv, pagos, empleo, observacion, elaboro, numero, cargo) VALUES ('$consecu', '$usuario', '$unidad', '$ciudad', '$fuente', '$testigo', '$valor', '$utilidad', '$sintesis', '$difusion', '$uni_dif', '$num_dif', '$fec_dif', '$pys', '$ano', '$firmas', '$plan', '$pagos', '$empleo', '$observa', '$elaboro', '$numero', '$cargo')";
