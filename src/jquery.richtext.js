    ...
    $.fn.richText = function (options) {
        var settings = $.extend({
            ...
            translations: {
                ...
                'addUnorderedList': 'Adicionar Viñeta',
                'addHeading': 'Adicionar Titulo',
                'addFont': 'Adicionar Fuente',
                'addFontColor': 'Adicionar Color de Fuente',
                'addFontSize': 'Adicionar Tamaño de Fuente',
                'addImage': 'Add image',
                'addVideo': 'Add video',
                'addFile': 'Add file',
                'addURL': 'Add URL',
