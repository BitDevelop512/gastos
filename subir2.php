...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Acta:&nbsp;<?php echo $acta; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/recompensas/".$alea."/".$carpeta."/".$acta."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload2.php?alea=<?php echo $alea; ?>&conse=<?php echo $carpeta; ?>&acta=<?php echo $acta; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
