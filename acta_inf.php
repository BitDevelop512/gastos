            ...
            <form name="formu" method="post">
              <div class="row">
                <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                  ...
                  <input type="hidden" name="unidades" id="unidades" class="form-control" value="<?php echo $numero1; ?>" readonly="readonly">
                  ...
                  <input type="hidden" name="centraliza" id="centraliza" class="form-control" value="<?php echo $n_centraliza; ?>" readonly="readonly">
              ...
              <div id="datos">
                ...
                <div class="row">
                  ...
                  <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    ...
                    <input type="text" name="cargo" id="cargo" class="form-control" value="<?php echo $car_usuario; ?>" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="18" autocomplete="off">
                  </div>
                </div>
                <br>
                <center>
...
$(document).ready(function () {
  ...
  $("#unidades1").select2.defaults.set("width", "100%");
  $("#unidades1").select2({
    tags: false,
    allowClear: false,
    closeOnSelect: true
...
function link1(valor, valor1, valor2, valor3)
{
  ...
  $("#plan_conse").val(valor);
  $("#plan_ano").val(valor1);
  $("#plan_unidad").val(valor2);
  $("#plan_sigla").val(valor3);
  formu3.submit();
}
function consultar()
{
    ...
    $.ajax({
      ...
      success: function (data)
      {
        ...
        if (tipo == "1")
        {
          ...
          salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='5%'><b>No.</b></td><td height='35' width='20%'><b>Acta</b></td><td height='35' width='8%'><b>Fecha</b></td><td height='35' width='8%'><b>Unidad</b></td><td height='35' width='8%'><b>Usuario</b></td><td height='35' width='15%'><b>Fuente</b></td><td height='35' width='10%'><center><b>Valor</b></center></td><td height='35' width='10%'><center><b>Plan</b></center></td><td width='4%' height='35'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td width='4%' height='35'>&nbsp;</td></tr></table>";
          ...
          $.each(registros.rows, function (index, value)
          {
            ...
            var datos2 = '\"'+value.conse+'\",\"'+value.ano+'\",\"'+value.unidad1+'\",\"'+value.unidad+'\"';
            ...
            salida2 += "<td width='15%' height='35' id='l6_"+index+"'>"+ced_fuente1+"</td>";
            ...
            if (v_ano == value.ano)
            {
              if (v_mes == v_mes1)
              {
                ...
                {
                	salida2 += "<td width='4%' height='35' id='l9_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); modif("+value.conse+","+value.unidad1+","+value.ano+")'><img src='imagenes/editar.png' border='0' title='Modificar'></a></center></td>";
                }
                else
                {
                	salida2 += "<td width='4%' height='35' id='l9_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
                }
              }
              else
              {
            ...
            salida2 += "<td width='4%' height='35' id='l10_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link1("+datos2+")'><img src='imagenes/pdf.png' border='0' title='Visualizar'></a></center></td>";
            // Contingencia
            if (servidor == "C")
            {
...
// 04/12/2024 - Ajuste boton visualizar
