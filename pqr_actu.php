...
if (is_ajax())
{
	...
	else
	{
		...
		if ($estado == "D")
		{
			$mensaje = "<br>SE LE HA ASIGNADO EL SOPORTE TÉCNICO CON EL INTERNO ".$conse." / ".$ano.".<br><br>";
		}
		else
		{
			$mensaje = "<br>SE HA DADO RESPUESTA A EL SOPORTE TÉCNICO CON EL INTERNO ".$conse." / ".$ano.".<br><br>";
		}
		...
		$query2 = "INSERT INTO cx_pqr_usu (conse, usuario, usuario1, estado, solicitud, ano) VALUES ('$consecu1', '$usuario1', '$usuario', '$estado', '$conse', '$ano')";
