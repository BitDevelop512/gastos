      ...
      <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <div id="soportes">
          ...
          <div>
            <form name="formu" method="post">
              <div class="row">
                <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                  ...
                  <select name="tipo" id="tipo" class="form-control select2" onchange="trae_movi(); trae_tipo();" tabindex="1">
            ...
            <input type="hidden" name="compa" id="compa" class="form-control" value="<?php echo $tip_usuario; ?>" readonly="readonly" tabindex="0">
...
function consultar()
{
  ...
  if ((tipo == "3") || (tipo == "4") || (tipo == "5"))
  {
    ...
    {
      salida = false;
      alerta("Debe ingresar una placa");
    }
  }
  if (tipo == "1")
  {
...
// 08/08/2023 - Nueva consulta de combustible registrado de transportes por rango de fecha - tipo=8
// 25/10/2023 - Inclusion filtro por placa
// 20/11/2023 - Mantenimiento excel
// 27/11/2023 - RTM excel
