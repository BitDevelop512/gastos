...
function cargar(valor)
{
  ...
  if (ancho > 1366)
  {
    var url = "<a href='./ver_norma.php?valor="+valor+"' name='lnk1' id='lnk1' class='pantalla-modal'></a>";
    $("#vinculo").html('');
    $("#vinculo").append(url);
  ...
  {
    var url = "<a href='./ver_norma.php?valor="+valor+"' target='_blank'><img src='dist/img/blanco.png' name='lnk1' id='lnk1' width='5' height='5' border='0'></a>";
    $("#vinculo").html('');
    $("#vinculo").append(url);
    $("#lnk1").click();
  }
