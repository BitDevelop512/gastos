...
else
{
  ...
  $query = "SELECT fecha FROM cx_act_cen WHERE conse='$conse' AND ano='$ano'";
  ...
  if(!file_exists($carpeta))
  {
	...
	{
		$pdf = "./".$fpdf."/".$informe."?conse=".$conse."&ano=".$ano."&ajuste=".$ajuste."&hoja=".$hoja."&comite=1";
	}
?>
<html lang="es">
	<head>
...
// 20/03/2024 - Ajuste cargue formato
?>