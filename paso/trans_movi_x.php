...
getProperties()
    ...
    ->setTitle("Consulta de Movimientos Vehículos")
...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A1', 'Clase')
    ->setCellValue('B1', 'Placa')
    ->setCellValue('C1', 'Tipo de Movimiento')
    ->setCellValue('D1', 'Fecha')
    ->setCellValue('E1', 'Acto Administrativo')
    ->setCellValue('F1', 'Unidad Origen')
    ->setCellValue('G1', 'Unidad Destino')
    ->setCellValue('H1', 'Año')
    ->setCellValue('I1', 'Observaciones')
    ->setCellValue('J1', 'Elaboro');
$j=2;
$m = count($paso1);
...
$objPHPExcel->getActiveSheet()->setTitle('Movimiento de Vehículos');
$objPHPExcel->setActiveSheetIndex(0);
header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="MovimientoVehiculos.xlsx"');
