...
else
{
  ...
  $placa = trim($_GET["valor2"]);
  $alea = trim($_GET["valor3"]);
  $unidad = trim($_GET["valor4"]);
  switch ($valor1)
  {
    case '36':
      $gasto1 = "combustible";
...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Factura Placa <?php echo $placa; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/".$gasto1."/".$placa."/".$unidad."/".$alea."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload22.php?gasto=<?php echo $gasto1; ?>&alea=<?php echo $alea; ?>&unidad=<?php echo $unidad; ?>&placa=<?php echo $placa; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
