...
if (is_ajax())
{
	...
	$query = "SELECT conse, misiones, estado, n_misiones, tipo FROM cx_pla_inv WHERE unidad='$uni_usuario' AND ordop='$ordop' AND n_ordop='$ordop1' AND estado IN ('D','F','G','H','W') AND compania='$compania' AND periodo IN ('$periodo','$periodo1') AND ano='$ano' ORDER BY conse";
	...
	while($i<$row=odbc_fetch_array($cur))
	{
		...
		if ($tipo == "1")
		{
			$query1 = "SELECT conse FROM cx_inf_aut WHERE unidad1='$uni_usuario' AND periodo='$periodo' AND ano='$ano'";
