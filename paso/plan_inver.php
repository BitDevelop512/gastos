...
else
{
  ...
  switch ($dun_usuario)
  {
    ...
    case '2':
    case '3':
      $campos = "com_a1, com_m1, gra_a1, gra_m1, man_a1, man_m1, rtm_a1, rtm_m1, lla_a1, lla_m1";
      break;
    case '4':
    case '5':
    case '6':
    case '7':
      $campos = "com_a2, com_m2, gra_a2, gra_m2, man_a2, man_m2, rtm_a2, rtm_m2, lla_a2, lla_m2";
      break;
    default:
      $campos = "com_a3, com_m3, gra_a3, gra_m3, man_a3, man_m3, rtm_a3, rtm_m3, lla_a3, lla_m3";
      break;
  }
  $query9 = "SELECT ".$campos." FROM cx_tra_tec";
  $sql9 = odbc_exec($conexion,$query9);
  // Combustible
  $combus1 = odbc_result($sql9,1);
  $combus1 = floatval($combus1);
  $combus2 = odbc_result($sql9,2);
  $combus2 = floatval($combus2);
  // Grasas
  $grasas1 = odbc_result($sql9,3);
  $grasas1 = floatval($grasas1);
  $grasas2 = odbc_result($sql9,4);
  $grasas2 = floatval($grasas2);
  // Mantenimiento
  $manteni1 = odbc_result($sql9,5);
  $manteni1 = floatval($manteni1);
  $manteni2 = odbc_result($sql9,6);
  $manteni2 = floatval($manteni2);
  // RTM
  $tecnico1 = odbc_result($sql9,7);
  $tecnico1 = floatval($tecnico1);
  $tecnico2 = odbc_result($sql9,8);
  $tecnico2 = floatval($tecnico2);
  // Llantas
  $llantas1 = odbc_result($sql9,9);
  $llantas1 = floatval($llantas1);
  $llantas2 = odbc_result($sql9,10);
  $llantas2 = floatval($llantas2);
?>
<html lang="es">
<head>
  <?php
            ...
            <form name="formu" method="post">
              ...
              <div class="row">
                <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                  ...
                  <input type="hidden" name="v_especial" id="v_especial" class="form-control" value="<?php echo $v_especial; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_salario" id="v_salario" class="form-control" value="<?php echo $salario; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_bienes" id="v_bienes" class="form-control" value="<?php echo $v_bienes; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_combustible" id="v_combustible" class="form-control" value="<?php echo $v_combustible; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_combustible1" id="v_combustible1" class="form-control" value="<?php echo $v_combustible1; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_grasas" id="v_grasas" class="form-control" value="<?php echo $v_grasas; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_llantas" id="v_llantas" class="form-control" value="<?php echo $v_llantas; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_llantas1" id="v_llantas1" class="form-control" value="<?php echo $v_llantas1; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_mantenimiento" id="v_mantenimiento" class="form-control" value="<?php echo $v_mantenimiento; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_mantenimiento1" id="v_mantenimiento1" class="form-control" value="<?php echo $v_mantenimiento1; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_rtm" id="v_rtm" class="form-control" value="<?php echo $v_rtm; ?>" readonly="readonly" tabindex="0">
                  <input type="hidden" name="v_rtm1" id="v_rtm1" class="form-control" value="<?php echo $v_rtm1; ?>" readonly="readonly" tabindex="0">
              ...
              <div class="row">
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <div id="cm_ordop">
                    <input type="text" name="ordop1" id="ordop1" class="form-control numero" onchange="javascript:this.value=this.value.toUpperCase();" onkeypress="return check1(event);" maxlength="20" tabindex="21" autocomplete="off">
                  </div>
                </div>
                <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                  <div id="cm_ordop1">
                    <input type="text" name="ordop" id="ordop" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" onblur="val_ordop4(); val_caracteres2('ordop');" maxlength="100" tabindex="22" autocomplete="off">
                  </div>
                </div>
                <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                  <div id="add_form">
                  ...
                  <input type="hidden" name="paso17" id="paso17" class="form-control" readonly="readonly" tabindex="0">
                  <input type="hidden" name="paso18" id="paso18" class="form-control" readonly="readonly" tabindex="0">
                  <input type="hidden" name="paso19" id="paso19" class="form-control" readonly="readonly" tabindex="0">
                  <input type="hidden" name="paso20" id="paso20" class="form-control" readonly="readonly" tabindex="0">
                  <input type="hidden" name="paso21" id="paso21" class="form-control" readonly="readonly" tabindex="0">
                  <?php
                    ...
                    <td>
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          ...
                          <input type="text" name="val_combus3" id="val_combus3" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_combus4" id="val_combus4" class="form-control numero" value="<?php echo $combus1; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Motocicletas</font></label>
                          <input type="text" name="val_combus5" id="val_combus5" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_combus6" id="val_combus6" class="form-control numero" value="<?php echo $combus2; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                      ...
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          ...
                          <input type="text" name="val_combus7" id="val_combus7" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_combus8" id="val_combus8" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Motocicletas</font></label>
                          <input type="text" name="val_combus9" id="val_combus9" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_combus10" id="val_combus10" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                  ...
                  <tr>
                    <td>
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Autom&oacute;viles</font></label>
                          <input type="text" name="val_tecnico3" id="val_tecnico3" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_tecnico4" id="val_tecnico4" class="form-control numero" value="<?php echo $tecnico1; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Motocicletas</font></label>
                          <input type="text" name="val_tecnico5" id="val_tecnico5" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_tecnico6" id="val_tecnico6" class="form-control numero" value="<?php echo $tecnico2; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                      ...
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Autom&oacute;viles</font></label>
                          <input type="text" name="val_tecnico7" id="val_tecnico7" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_tecnico8" id="val_tecnico8" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Motocicletas</font></label>
                          <input type="text" name="val_tecnico9" id="val_tecnico9" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_tecnico10" id="val_ctecnico10" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3"></div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3"></div>
                      </div>
                  ...
                  <tr>
                    <td>
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Autom&oacute;viles</font></label>
                          <input type="text" name="val_llantas3" id="val_llantas3" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_llantas4" id="val_llantas4" class="form-control numero" value="<?php echo $llantas1; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Motocicletas</font></label>
                          <input type="text" name="val_llantas5" id="val_llantas5" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_llantas6" id="val_llantas6" class="form-control numero" value="<?php echo $llantas2; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                      ...
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Autom&oacute;viles</font></label>
                          <input type="text" name="val_llantas7" id="val_llantas7" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_llantas8" id="val_llantas8" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Motocicletas</font></label>
                          <input type="text" name="val_llantas9" id="val_llantas9" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_llantas10" id="val_llantas10" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3"></div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3"></div>
                      </div>
                  ...
                  <tr>
                    <td>
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Autom&oacute;viles</font></label>
                          <input type="text" name="val_manteni3" id="val_manteni3" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_manteni4" id="val_manteni4" class="form-control numero" value="<?php echo $manteni1; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Techo Motocicletas</font></label>
                          <input type="text" name="val_manteni5" id="val_manteni5" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_manteni6" id="val_manteni6" class="form-control numero" value="<?php echo $manteni2; ?>" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                      ...
                      <div class="row">
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Autom&oacute;viles</font></label>
                          <input type="text" name="val_manteni7" id="val_manteni7" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_manteni8" id="val_manteni8" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">Suma Motocicletas</font></label>
                          <input type="text" name="val_manteni9" id="val_manteni9" class="form-control numero" value="0.00" onfocus="blur();" readonly="readonly">
                          <input type="hidden" name="val_manteni10" id="val_manteni10" class="form-control numero" value="0" onfocus="blur();" readonly="readonly">
                        </div>
                        <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                          <label><font face="Verdana" size="2">I.V.A. Total</font></label>
                          <input type="text" name="iva_man1" id="iva_man1" class="form-control numero" value="0.00" onkeyup="paso_val8_2(); suma8_1();" autocomplete="off">
...
function suma4(valor, valor1, valor2)
{
  ...
  valor11 = valor9.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  valor12 = valor10.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  $("#val_combus7").val(valor12);
  $("#val_combus8").val(valor10);
  $("#val_combus9").val(valor11);
  $("#val_combus10").val(valor9);
  valor13 = $("#val_combus4").val();
  valor14 = $("#val_combus6").val();
  if (valor15 > valor14)
  {
    var detalle = "Valor Superior a Techo de Motocicletas";
    alerta(detalle);
    $("#aceptar10").hide();
    techo1 = false;
  }
  ...
  if (valor16 > valor13)
  {
    var detalle = "Valor Superior a Techo de Automóviles";
    alerta(detalle);
    $("#aceptar10").hide();
    techo2 = false;
  }
...
function suma6(valor, valor1, valor2)
{
  ...
  valor14 = valor12.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  valor15 = valor13.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  $("#val_tecnico7").val(valor15);
  $("#val_tecnico8").val(valor13);
  $("#val_tecnico9").val(valor14);
  $("#val_tecnico10").val(valor12);
  valor16 = $("#val_tecnico4").val();
  valor17 = $("#val_tecnico6").val();
  if (valor18 > valor17)
  {
    var detalle = "Valor Superior a Techo de Motocicletas";
    alerta(detalle);
...
function suma7(valor, valor1, valor2)
{
  ...
  valor14 = parseFloat(valor14);
  valor15 = valor13.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  valor16 = valor14.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  $("#val_llantas7").val(valor16);
  $("#val_llantas8").val(valor14);
  $("#val_llantas9").val(valor15);
  $("#val_llantas10").val(valor13);
  valor17 = $("#val_llantas4").val();
  valor18 = $("#val_llantas6").val();
  if (valor19 > valor18)
  {
    var detalle = "Valor Superior a Techo de Motocicletas";
    alerta(detalle);
...
function suma8(valor, valor1, valor2)
{
  ...
  valor7 = parseFloat(valor7);
  // Techos
  valor18 = parseFloat(valor18);
  valor19 = parseFloat(valor19);
  valor20 = valor18.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  valor21 = valor19.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
  $("#val_manteni7").val(valor21);
  $("#val_manteni8").val(valor19);
  $("#val_manteni9").val(valor20);
  $("#val_manteni10").val(valor18);
  valor22 = $("#val_manteni4").val();
  valor23 = $("#val_manteni6").val();
  if (valor24 > valor23)
  {
    var detalle = "Valor Superior a Techo de Motocicletas";
    alerta(detalle);
...
function bienes(valor, valor1)
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      {
        var detalle = "<center><h3>Valor No Permitido</h3></center>";
        $("#dialogo").html(detalle);
        $("#dialogo").dialog("open");
        $("#dialogo").closest(".ui-dialog").find(".ui-dialog-titlebar-close").hide();
  ...
  else
  {
    ...
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<table width='100%' align='center' border='0'><tr><td width='6%' height='35'><b>No.</b></td><td width='13%' height='35'><b>Fecha</b></td><td width='9%' height='35'><b>Periodo</b></td><td width='15%' height='35'><b>Unidad</b></td><td width='15%' height='35'><b>Tipo</b></td><td width='12%' height='35'><b>Usuario</b></td><td width='5%' height='35'>&nbsp;</td><td width='5%' height='35'>&nbsp;</td><td width='5%' height='35'>&nbsp;</td><td width='5%' height='35'>&nbsp;</td><td width='5%' height='35'>&nbsp;</td></tr></table>";
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          salida2 += "<td width='13%' height='35' id='l2_"+value.conse+"'>"+value.fecha+"</td>";
          salida2 += "<td width='9%' height='35' id='l3_"+value.conse+"'>"+value.periodo+" - "+value.ano+"</td>";
          salida2 += "<td width='15%' height='35' id='l4_"+value.conse+"'>"+value.unidad+"</td>";
          ...
          else
          {
            if ((v_ano == value.ano) || (v_ano1 == value.ano))
            {
              ...
              {
                salida2 += "<td width='5%' height='35' id='l7_"+value.conse+"'><center><a href='#' onclick='javascript:highlightText2("+value.conse+",12); modif("+value.conse+","+value.ano+")'><img src='imagenes/editar.png' border='0' title='Modificar'></a></center></td>";
              }
              else
              {
                salida2 += "<td width='5%' height='35' id='l7_"+value.conse+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          ...
          salida2 += "<td width='5%' height='35' id='l8_"+value.conse+"'><center><a href='#' onclick='javascript:highlightText2("+value.conse+",12); link("+value.conse+","+value.ano+","+value.tipo1+")'><img src='imagenes/pdf.png' border='0' title='Visualizar'></a></center></td>";
          if ((value.estado == "P") || (value.estado == "A") || (value.estado == "B") || (value.estado == "C") || (value.estado == "D") || (value.estado == "E") || (value.estado == "F") || (value.estado == "G") || (value.estado == "H") || (value.estado == "J") || (value.estado == "K") || (value.estado == "L") || (value.estado == "M") || (value.estado == "N") || (value.estado == "O") || (value.estado == "P") || (value.estado == "Q") || (value.estado == "R") || (value.estado == "S") || (value.estado == "X") || (value.estado == "W"))
          {
          ...
          else
          {
            if ((v_ano == value.ano) || (v_ano1 == value.ano))
            {
              if (usu == value.usuario)
              {
                salida2 += "<td width='5%' height='35' id='l9_"+value.conse+"'><center><a href='#' onclick='javascript:highlightText2("+value.conse+",12); paso3("+value.conse+","+value.tipo1+","+value.ano+"); pregunta3();'><img src='imagenes/anular.png' border='0' title='Anular'></a></center></td>";
              }
              else
              {
                salida2 += "<td width='5%' height='35' id='l9_"+value.conse+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          ...
          salida2 += "<td width='5%' height='35' id='l10_"+value.conse+"'><center><a href='./archivos/index1.php?ano="+value.ano+"&conse="+value.conse+"' onclick='javascript:highlightText2("+value.conse+",12);' class='pantalla-modal'><img src='imagenes/clip.png' border='0' title='Anexos'></a></center></td>";
          if (super1 == "1")
          {
            salida2 += "<td width='5%' height='35' id='l11_"+value.conse+"'><center><a href='#' onclick='javascript:highlightText2("+value.conse+",12); des_plan("+value.conse+","+value.ano+");'><img src='dist/img/download.png' width='32' height='32' border='0' title='Descargar'></a></center></td>";
          }
          else
          {
          ...
          if (super1 == "1")
          {
            salida2 += "<td width='5%' height='35' id='l12_"+value.conse+"'><center><a href='#' onclick='javascript:highlightText2("+value.conse+",12); del_pdf("+value.conse+","+value.ano+","+index+");'><img src='dist/img/delete.png' name='pdf_"+index+"' id='pdf_"+index+"' width='29' height='29' border='0' title='Eliminar PDF'></a></center></td>";
          }
          else
          {
