...
if (is_ajax())
{
	...
	$graba = "INSERT INTO cx_sol_aut (conse, usuario, unidad, planes, ano, firmas, asunto, sustentacion, observaciones, elaboro) VALUES ('$consecu', '$usu_usuario', '$uni_usuario', '$conses2', '$ano', '$firmas', '$asunto', '$sustenta', '$observa', '$elaboro')";
