            ...
            <form name="formu" method="post">
              <div class="row">
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  ...
                  <input type="text" name="filtro" id="filtro" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="50" autocomplete="off" tabindex="1">
                </div>
                <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                  <label><font face="Verdana" size="2">Descripci&oacute;n:</font></label>
                  <input type="text" name="filtro1" id="filtro1" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="50" autocomplete="off" tabindex="2">
                </div>
                <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                  <label><font face="Verdana" size="2">Clasificaci&oacute;n:</font></label>
                  <select name="filtro3" id="filtro3" class="form-control select2" tabindex="3"></select>
                </div>
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <label><font face="Verdana" size="2">Unidad:</font></label>
                  <select name="filtro2" id="filtro2" class="form-control select2" tabindex="4"></select>
                </div>
              ...
              <div class="row">
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  ...
                  <input type="text" name="filtro4" id="filtro4" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="50" autocomplete="off" tabindex="5">
                </div>
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <label><font face="Verdana" size="2">Color:</font></label>
                  <input type="text" name="filtro5" id="filtro5" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="50" autocomplete="off" tabindex="6">
                </div>
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <label><font face="Verdana" size="2">Modelo:</font></label>
                  <input type="text" name="filtro6" id="filtro6" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="50" autocomplete="off" tabindex="7">
                </div>
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <label><font face="Verdana" size="2">Serial:</font></label>
                  <input type="text" name="filtro7" id="filtro7" class="form-control" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="50" autocomplete="off" tabindex="8">
                </div>
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                ...
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  ...
                  <input type="text" name="filtro9" id="filtro9" class="form-control numero" value="0.00" onkeyup="paso_val1();" autocomplete="off" tabindex="11">
              ...
              <hr>
              <div id="tabla1"></div>
              <div id="resultados7"></div>
              <input type="hidden" name="n_unidad" id="n_unidad" class="form-control" value="<?php echo $n_unidad; ?>" readonly="readonly" tabindex="0">
              <input type="hidden" name="n_dependencia" id="n_dependencia" class="form-control" value="<?php echo $n_dependencia; ?>" readonly="readonly" tabindex="0">
...
$(document).ready(function () {
  ...
  $("#valos").maskMoney();
  $("#filtro").keyup(trae_bienes1);
  $("#filtro1").keyup(trae_bienes1);
  $("#filtro2").change(trae_bienes1);
  $("#filtro3").change(trae_bienes1);
  $("#filtro4").keyup(trae_bienes1);
  $("#filtro5").keyup(trae_bienes1);
  $("#filtro6").keyup(trae_bienes1);
  $("#filtro7").keyup(trae_bienes1);
  $("#filtro8").maskMoney();
  $("#filtro9").maskMoney();
  $("#img1").hide();
  $("#img2").hide();
...
function trae_bienes(valor)
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      salida1 += "<table width='100%' align='center' border='0'><tr><td width='10%'><font size='2'><b>C&oacute;digo</b></font></td><td width='38%'><font size='2'><b>Descripci&oacute;n</b></font></td><td width='15%'><center><font size='2'><b>Clase</b></font></center></td><td width='10%'><font size='2'><b>Unidad</b></font></td><td width='10%'><font size='2'><b>Marca</b></font></td><td width='10%'><center><font size='2'><b>Valor</b></font></center></td><td width='7%'>&nbsp;</td></tr></table>";
      ...
      $.each(registros.rows, function (index, value)
      {
        ...
        salida2 += "<tr><td width='10%' height='35'>"+value.codigo+"</td>";
        salida2 += "<td width='38%' height='35'>"+value.descripcion+"</td>";
        salida2 += "<td width='15%' height='35'>"+value.n_clase+"</td>";
        salida2 += "<td width='10%' height='35'>"+value.unidad1+"</td>";
        salida2 += "<td width='10%' height='35'>"+value.marca+"</td>";
        salida2 += "<td width='10%' height='35' align='right'>"+value.valor+"</td>";
        if ($("#historico").is(":checked"))
        {
          salida2 += "<td width='5%' height='35'>&nbsp;</td></tr>";
        }
        else
        {
          salida2 += "<td width='7%' height='35'><center><a href='#' onclick='actu("+paso+")'><img src='imagenes/editar.png' width='24' height='24' border='0' title='Modificar'></a>";
          if (value.alea == "")
          {
            salida2 += "&nbsp;&nbsp;&nbsp;<img src='imagenes/blanco.png' width='24' height='24' border='0'></center></td></tr>";
          }
          else
          {
            salida2 += "&nbsp;&nbsp;&nbsp;<a href='#' onclick='factura("+paso1+")'><img src='imagenes/pdf.png' width='24' height='24' border='0' title='Factura'></a></center></td></tr>";
          }
        }
...
function trae_bienes1()
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      {
        var paso = '\"'+value.conse+'\",\"'+value.codigo+'\"';
        var paso1 = '\"'+value.alea+'\",\"'+value.unidad1+'\"';
        salida2 += "<tr><td width='10%' height='35'>"+value.codigo+"</td>";
        salida2 += "<td width='38%' height='35'>"+value.descripcion+"</td>";
        salida2 += "<td width='15%' height='35'>"+value.n_clase+"</td>";
        salida2 += "<td width='10%' height='35'>"+value.unidad1+"</td>";
