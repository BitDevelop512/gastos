                ...
                <img src="imagenes/cargando1.gif" alt="Cargando..." />
                  ...
                  <table width="65%" border="0">
                    ...
                    <select name="clase" id="clase" class="form-control select2" tabindex="4">
                      ...
                      <option value="2">ADMINISTRADOR TRANSPORTES</option>
...
$(document).ready(function () {
  ...
  $("#actualizar").css({ width: '150px', 'padding-top': '8px', 'padding-bottom': '8px' });
  $("#actualizar").hide();
  $("#cancelar").button();
  $("#cancelar").click(recarga);
  $("#cancelar").css({ width: '150px', 'padding-top': '8px', 'padding-bottom': '8px' });
  $("#cancelar").hide();
  $("#lbl_rol").hide();
  consulta();
  $("#usuario").focus();
    ...
    if (conse == "0")
    {
      $.ajax({
        ...
        success: function (data)
        {
          ...
          if (valida > 0)
          {
            detalle = "<center><h3>Usuario Existente</h3></center>";
