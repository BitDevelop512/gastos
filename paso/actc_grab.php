...
if (is_ajax())
{
	...
	else
	{
		if ($tipo == "1")
		{
			...
			$query = "INSERT INTO cx_act_cen (conse, usuario, unidad, estado, ano, registro, ano1, valor, directiva, firmas, sintesis, informacion, totali, neutralizados, totaln, material, totalm, totala, concepto, observaciones, elaboro, acta, constancia, folio, valoracion, reviso, salario, fec_act, impacto, aprobacion) VALUES ('$consecu', '$usuario', '$unidad', '', '$ano', '$registro1', '$ano1', '$valor', '$directiva', '$firmas', '$sintesis', '$informacion', '$totali', '$neutralizados', '$totaln', '$material', '$totalm', '$totala', '$concepto', '$observaciones', '$elaboro', '$acta', '$constancia', '$folio', '$valoracion', '$reviso', '$salario', '$fec_act', '$impacto', '$aprobacion')";
