...
if (is_ajax())
{
	...
	$ordop1 = trim($ordop1);
	$conse = $_POST['conse'];
	$query = "SELECT conse, misiones, estado, n_misiones, tipo FROM cx_pla_inv WHERE usuario='$usu_usuario' AND unidad='$uni_usuario' AND ordop='$ordop' AND n_ordop='$ordop1' AND estado IN ('D','F','G','H','W') AND periodo IN ('$periodo','$periodo1') AND ano='$ano' ORDER BY conse";
