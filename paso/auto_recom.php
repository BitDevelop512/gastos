    ...
    $.ajax({
      ...
      success: function (data)
      {
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          salida2 += "<td width='13%' height='35' id='l7_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",8); link2("+value.conse+","+value.ano+");'><img src='imagenes/pdf.png' border='0' title='Ver Autorización'></a></center></td>";
          // Eliminar PDF Final
          if (super1 == "1")
          {
