	...
	else
	{
		...
		else
		{
			...
			if ($tipo == "1")
			{
				...
				$graba = "INSERT INTO cx_inf_aut (conse, usuario, unidad, periodo, ano, unidad1, gastos, pagos, total, plazo, directiva, otro) VALUES ('$consecu', '$usu_usuario', '$uni_usuario', '$periodo', '$ano', '$unidad', '$gastos', '$pagos', '$total', '$plazo', '$direcitva', '$instruccion')";
			}
			else
			{
