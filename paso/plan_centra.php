  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      if (tp_admin == "8")
      {
        if (v_revisa == "0")
        {
          var detalle = "<center><h3>Plan de Inversión Centralizado<br>Sin Revisión</h3></center>";
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      if (tp_admin == "9")
      {
        if (v_ordena == "0")
        {
          var detalle = "<center><h3>Plan de Inversión Centralizado<br><br>Sin Revisión</h3></center>";
          $("#dialogo").html(detalle);
          $("#dialogo").dialog("open");
          $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
          $("#res_unic").html('');
  ...
  $.ajax({
    ...
    success: function (data)
    {
        ...
        if ((tp_admin == "10") || (tp_admin == "25"))
        {
          ...
          else
          {
            ...
            if (index == "1")
            {
                if (value.conso1 == "1")
                {
                  salida += '<td height="35"><center><a href="#" onclick="link2('+value.conso+')"><img src="imagenes/pdf.png" border="0" title="Visualizar Plan / Solicitud"></a></center></td></tr>';
                }
                else
                {
                  salida += '<td height="35">&nbsp;</td><td height="35">&nbsp;</td></tr>';
      ...
      if (tp_admin == "11")
      {
        ...
        {
          $("#aceptar5").hide();
          var detalle = "<center><h3>Saldos no registrados<br>para el periodo seleccionado</h3></center>";
          $("#dialogo").html(detalle);
          $("#dialogo").dialog("open");
          $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
        }
...
function consulta3()
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      salida += '<tr><td height="35">Pago de Informaciones</td><td align="right" height="35"><input type="text" name="pagos" id="pagos" class="c7" value="0.00" onfocus="blur();" readonly="readonly" style="border-style: none; background: transparent; color: #000;"><input type="hidden" name="pagos1" id="pagos1" class="c7" value="0" readonly="readonly"></td><td colspan="4" height="35"><input type="text" name="pagos2" id="pagos2" class="form-control" onfocus="blur();" readonly="readonly" style="border-style: none; background: transparent; color: #000;" maxlength="100" autocomplete="off"></td></tr>';
      salida += '<tr><td height="35">Pago de Recompensas</td><td align="right" height="35"><input type="text" name="recompensas" id="recompensas" class="c7" value="0.00" onfocus="blur();" readonly="readonly" style="border-style: none; background: transparent; color: #000;"><input type="hidden" name="recompensas1" id="recompensas1" class="c7" value="0" readonly="readonly"></td><td colspan="4" height="35"><input type="text" name="recompensas2" id="recompensas2" class="form-control" onfocus="blur();" readonly="readonly" style="border-style: none; background: transparent; color: #000;" maxlength="100" autocomplete="off"></td></tr>';
      salida += '<tr><td height="35"><b>OBSERVACIONES:</b></td><td height="35" colspan="5"><textarea name="nota" id="nota" rows="4" class="form-control" readonly="readonly" style="border-style: none; background: transparent; color: #000;" /></td></tr>';
      salida += '</table>';
...
function graba()
{
  ...
  if ((tp_admin == "6") || (tp_admin == "10") || (tp_admin == "25"))
  {
    ...
    if ($("#gastos2").val() == '')
    {
      ...
      salida = false;
      detalle += "Debe ingresar una justificación del saldo de Gastos<br><br>";
    }
    else
    {
    ...
    if ($("#pagos2").val() == '')
    {
      ...
      salida = false;
      detalle += "Debe ingresar una justificación del saldo de Informaciones<br><br>";
    }
    else
    {
    ...
    if ($("#recompensas2").val() == '')
    {
      ...
      salida = false;
      detalle += "Debe ingresar una justificación del saldo de Recompensas<br><br>";
    }
    else
    {
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      if (valida == "1")
      {
        ...
        var detalle = "<center><h3>Saldos ya registrados<br>para el periodo seleccionado</h3></center>";
        $("#dialogo").html(detalle);
        $("#dialogo").dialog("open");
        $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
      }
...
function link()
{
  ...
  var ano = $("#ano").val();
	$("#centra_per").val(periodo);
	$("#centra_ano").val(ano);
	$("#centra_uni").val(unidades);
	formu4.submit();
}
function link1(valor)
{
  ...
  if (valor == "0")
  {
    var detalle = "<center><h3>Consolidado No Encontrado en la Base de Datos</h3></center>";
    $("#dialogo").html(detalle);
    $("#dialogo").dialog("open");
    $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
  }
