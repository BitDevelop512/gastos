...
if (is_ajax())
{
	...
	$query = "SELECT SUM(gastos) AS gastos, SUM(pagos) AS pagos, SUM(total) AS total FROM cx_val_aut1 WHERE conse IN ($con) AND periodo='$periodo' AND ano='$ano' AND estado='V' AND inf_giro='0'";
	$sql = odbc_exec($conexion, $query);
    // Total Unidades
    $query1 = "SELECT unidad, sigla, depen, n_depen, gastos, pagos, total, conse, uom FROM cx_val_aut1 WHERE conse IN ($con) AND periodo='$periodo' AND ano='$ano' AND estado='V' AND inf_giro='0' ORDER BY unidad";
    ...
    else
    {
        ...
        $query2 = "SELECT COUNT(1) AS contador, depen, n_depen, SUM(gastos) AS gastos, SUM(pagos) AS pagos, SUM(total) AS total FROM cx_val_aut1 WHERE conse IN ($con) AND periodo='$periodo' AND ano='$ano' AND estado='V' AND inf_giro='0' AND uom<=3  GROUP BY depen, n_depen ORDER BY depen";
        ...
        $query3 = "SELECT COUNT(1) AS contador, uom, n_uom, SUM(gastos) AS gastos, SUM(pagos) AS pagos, SUM(total) AS total FROM cx_val_aut1 WHERE conse IN ($con) AND periodo='$periodo' AND ano='$ano' AND estado='V' AND inf_giro='0' AND uom>3  GROUP BY uom, n_uom ORDER BY uom";
