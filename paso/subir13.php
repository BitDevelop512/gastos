...
{
  $acta = $_GET["acta"];
  $ruta_local1 = $ruta_local."\\upload\\verificacion";
  if(!file_exists($ruta_local1))
  {
    mkdir ($ruta_local1);
  }
  $carpeta1 = $ruta_local1."\\".$acta;
...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Informe Verificaci&oacute;n</font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/verificacion/".$acta."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload13.php?acta=<?php echo $acta; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
