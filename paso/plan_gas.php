              ...
              <div id="datos1">
                <div class="row">
                  ...
                  <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                    ...
                    <input type="text" name="adicional" id="adicional" class="form-control" onkeypress="return check1(event);" maxlength="25" autocomplete="off">
                  </div>
                </div>
                <hr>
              </div>
...
function busca()
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      $("#datos1").show();
      $("#add_field").click();
      var detalle = "<h3><center>No olvide registrar el número de misión adicional, si aplica</center></h3>";
