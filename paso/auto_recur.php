...
function consultar()
{
  $.ajax({
    ...
    success: function (data)
    {
      ...
      salida += "<tr><td width='3%' height='25'>&nbsp;</td><td width='8%' height='25'><center><b>Solicitud</b></center></td><td width='17%' height='25'><center><b>Fecha</b></center></td><td width='9%' height='25'><center><b>Unidad</b></center></td><td width='9%' height='25'><center><b>Periodo / Año</center></b></td><td width='14%' height='25'><center><b>Gastos</b></center></td><td width='14%' height='25'><center><b>Pagos</b></center></td><td width='14%' height='25'><center><b>Total</b></center></td><td width='4%' height='25'>&nbsp;</td><td width='4%' height='25'>&nbsp;</td><td width='4%' height='25'>&nbsp;</td></tr>";
      ...
      for (var j=0; j<var_con1-1; j++)
      {
        ...
        var paso3 = var1+","+j;
        var var15 = var_tot[j];
        var15 = parseInt(var15);
        var var16 = var_var[j];
        var paso4 = "\'"+var16+"\'";
        var paso5 = "\'"+var11+"\'";
        var var17 = var1+"&"+var14+"&"+var16;
        salida += '<tr><td width="3%" height="35"><input type="checkbox" name="seleccionados[]" id="chk_'+j+'" value="'+paso3+'" onclick="trae_marca('+j+','+var1+');"></td><td width="8%" height="35"><center>'+var1+'</center></td><td width="17%" height="35">'+var2+'</td><td width="9%" height="35"><center>'+var5+'</center></td><td width="9%" height="35"><center>'+var3+' - '+var4+'<input type="hidden" name="per_'+j+'" id="per_'+j+'" class="c7" value="'+var3+'"><input type="hidden" name="ano_'+j+'" id="ano_'+j+'" class="c7" value="'+var4+'"><input type="hidden" name="uni_'+j+'" id="uni_'+j+'" class="c7" value="'+var14+'"></center></td><td align="right" width="14%" height="35"><input type="text" name="va1_'+j+'" id="va1_'+j+'" class="c7" value="'+var9+'" onkeyup="paso_val1('+j+'); totaliza('+j+');" style="border-style: none; background: transparent; color: #000;"><input type="hidden" name="vb1_'+j+'" id="vb1_'+j+'" class="c7" value="'+var8+'"><input type="hidden" name="vo1_'+j+'" id="vo1_'+j+'" class="c7" value="'+var9+'"></td><td align="right" width="14%" height="35">';
        if (var15 > 1)
        {
        ...
        salida += '<input type="hidden" name="vp_'+j+'" id="vp_'+j+'" class="c7" value="'+var17+'" style="border-style: none; background: transparent; color: #000;"><input type="text" name="va2_'+j+'" id="va2_'+j+'" class="c7" value="'+var11+'" onkeyup="paso_val2('+j+'); totaliza('+j+');" onblur="modif1('+j+');" style="border-style: none; background: transparent; color: #000;"><input type="hidden" name="vb2_'+j+'" id="vb2_'+j+'" class="c7" value="'+var10+'"><input type="hidden" name="vo2_'+j+'" id="vo2_'+j+'" class="c7" value="'+var11+'"></td><td align="right" width="14%" height="35"><input type="text" name="va3_'+j+'" id="va3_'+j+'" class="c7" value="'+var13+'" onfocus="blur();" readonly="readonly" style="border-style: none; background: transparent; color: #000;"><input type="hidden" name="vb3_'+j+'" id="vb3_'+j+'" class="c7" value="'+var12+'"></td><td width="4%" height="35"><center><a href="#" onclick="link('+paso+','+paso1+','+paso2+')"><img src="imagenes/pdf.png" border="0" title="Visualizar Solicitud"></a></center></td><td width="4%" height="35"><center><a href="#" onclick="ver_anex('+var1+','+var4+')"><img src="imagenes/clip.png" border="0" title="Ver Anexos"></a></center></td><td width="4%" height="35"><center><a href="#" onclick="rechazar('+var1+','+var4+')"><img src="imagenes/anular.png" border="0" title="Rechazar"></a></center></td></tr>';
      }
      salida += '</table>';
      if (total > 0)
      {
    ...
    $.ajax({
      ...
      success: function (data)
      {
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          salida2 += "<td width='10%' height='35' id='l7_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",9); link4("+value.conse+","+value.ano+");'><img src='imagenes/pdf.png' border='0' title='Ver Acta'></a></center></td>";
          salida2 += "<td width='10%' height='35' id='l8_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",9); link3("+value.conse+","+value.ano+");'><img src='imagenes/pdf.png' border='0' title='Ver Autorización'></a></center></td>";
          // Eliminar PDF Final
          if (super1 == "1")
          {
