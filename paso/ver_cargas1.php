    ...
    while ($i < $row = odbc_fetch_array($sql))
    {
      ...
      ?>
        <table width="95%" align="center" border="1">
          <tr>
            <td colspan="4" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Combustible</font></b></center></td>
          </tr>
        <?php
      ...
      ?>
        <table width="95%" align="center" border="1">
          <tr>
            <td colspan="4" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Combustible Adicional</font></b></center></td>
          </tr>
          <?php
          $num_datos = explode("|",$datos);
          for ($j=0;$j<count($num_datos)-1;++$j)
