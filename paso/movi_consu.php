            ...
            while ($i < $row = odbc_fetch_array($sql))
            {
                ...
                switch ($n_tipo)
                {
                    ...
                    case '4':
                        ...
                        break;
                    case '5':
                        $tipo = "ASIGNACI&Oacute;N USUARIO FINAL";
                        break;
                    case '6':
                        $tipo = "REVISTA CONFRONTACI&Oacute;N DE CARGOS";
                        break;
                    default:
                        $tipo = "";
                        break;
                ...
                if (($n_tipo == "1") || ($n_tipo == "2") || ($n_tipo == "3") || ($n_tipo == "4") || ($n_tipo == "5") || ($n_tipo == "6"))
                {
                    ...
                    if ($n_tipo == "6")
                    {
                        $ruta = "upload/movimientos/".$n_unidad."/revista/".$alea."/";
                    }
                    else
                    {
                        $v1 = explode("_", $usu_usuario);
                        ...
                        if ($n_tipo == "1")
                        {
                            $ruta = "upload/movimientos/".$n_unidad."/asignacion/".$alea."/";
                        }
                        else
                        {
                            if ($n_tipo == "4")
                            {
                                $ruta = "upload/movimientos/".$n_unidad."/traspaso/".$alea."/";
                            }
                            else
                            {
                                if ($n_tipo == "3")
                                {
                                    $ruta = "upload/movimientos/".$n_unidad."/consumo/".$alea."/";
                                }
                                else
                                {
                                    if ($n_tipo == "2")
                                    {
                                        $ruta = "upload/movimientos/".$n_unidad."/salida/".$alea."/";
                                    }
                                    else
                                    {

                                        $ruta = "upload/movimientos/".$n_unidad."/usuario/".$alea."/";
                                    }
                                }
                            }
                        }
