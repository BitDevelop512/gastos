...
if (is_ajax())
{
	...
	$actu = "UPDATE cx_reg_rec SET estado='F' WHERE conse='$conse' AND ano='$ano1'";
	...
	{
		$confirma = "1";
		$actu1 = "UPDATE cx_act_cen SET estado='F' WHERE conse='$numero' AND ano='$ano'";
	...
	$mensaje = "SE ELABORO EL ACTA DE COMITE CENTRAL DE RECOMPENSAS ".$numero." / ".$ano.".";
