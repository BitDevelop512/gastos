            ...
            <form name="formu" method="post">
              ...
              <div id="datos3">
                ...
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <label><font face="Verdana" size="2">Unidad</font></label>
                    <select name="unidad1" id="unidad1" class="form-control" tabindex="8"><option value="0">- SELECCIONAR -</option></select>
                  </div>
                  <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      $.each(registros.rows, function (index, value)
      {
        ...
        salida2 += "<tr><td height='35' width='10%' id='l1_"+index+"'>"+value.clase+"</td>";
