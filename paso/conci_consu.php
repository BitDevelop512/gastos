...
if (is_ajax())
{
    ...
    $ano = $_POST['ano'];
    $cuenta = $_POST['cuenta'];
    $query = "SELECT saldo, debito, credito, cheques, libros FROM cx_con_ban WHERE unidad='$uni_usuario' AND periodo='$periodo' AND ano='$ano' AND cuenta='$cuenta'";
    ...
    if ($cuenta == "1")
    {
        $query1 = "SELECT saldo FROM cx_sal_uni WHERE unidad='$uni_usuario' AND periodo='$periodo' AND ano='$ano'";
