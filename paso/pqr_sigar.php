...
function trae_registros()
{
  $.ajax({
    ...
    success: function (data)
    {
      ...
      salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='7%'><b>No.</b></td><td height='35' width='12%'><b>Fecha</b></td><td height='35' width='8%'><b>Usuario</b></td><td height='35' width='7%'><b>Unidad</b></td><td height='35' width='7%'><b>Tipo</b></td><td height='35' width='16%'><b>M&oacute;dulo - Sub M&oacute;dulo</b></td><td height='35' width='13%'><b>Estado</b></td><td height='35' width='17%'><b>D&iacute;as</b></td><td height='35' width='10%'><b>Asignado</b></td><td height='35' width='3%'>&nbsp;</td></tr></table>";
      ...
      $.each(registros.rows, function (index, value)
      {
        ...
        salida2 += "<td height='35' width='17%' id='l8_"+v1+"'>"+value.fechaf+" - "+value.solucion+"</td>";
        salida2 += "<td height='35' width='10%' id='l9_"+v1+"'>"+value.asigna+"</td>";
        salida2 += "<td height='35' width='3%' id='l10_"+v1+"'><center><a href='#' onclick='javascript:highlightText2("+v1+",10); veri("+valida2+")'><img src='imagenes/ver.png' border='0' title='Ver Información'></a></center></td>";
        listareg.push(v1);
      });
      salida2 += "</table>";
...
// 05/12/2023 - Inclusión usuario asigando
?>