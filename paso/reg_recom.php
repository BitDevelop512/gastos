            ...
            <form name="formu" method="post">
              ...
              <div class="row">
                <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                  ...
                  <?php
                  $menu1_1 = odbc_exec($conexion,"SELECT subdependencia,sigla FROM cx_org_sub WHERE tipo IN ('7', '8') ORDER BY sigla");
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      {       
        ...
        if (valida2 == "")
        {
          var detalle = "<center><h3>Lista de Verificaci&oacute;n No Registrada</h3></center>";
          $("#dialogo6").html(detalle);
          $("#dialogo6").dialog("open");
          $("#dialogo6").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
        }
...
// 04/10/2023 - Busqueda sobre combo de unidad efectua
?>