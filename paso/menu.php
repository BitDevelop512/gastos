...
$cur1 = odbc_exec($conexion,"SELECT count(1) AS contador FROM cx_notifica WHERE usuario1='$usu_usuario' AND unidad1='$uni_usuario' AND visto='1'");
$contador = odbc_result($cur1,1);
?>
<html>
<head>
