...
if (is_ajax())
{
	...
	{
		$responsable1 = $responsable."»RESPONSABLE MISIÓN»";
	}
	...
	if ($tipo == "2")
	{
		...
		if ($estado == "Y")
		{
			$graba2 = "UPDATE cx_pla_inv SET usuario1='', usuario2='', usuario3='', usuario4='', usuario5='', usuario6='', usuario7='', usuario8='', usuario9='', usuario10='', usuario11='', usuario12='', usuario13='', estado='$estado', recursos='0' WHERE conse='$conse' AND ano='$ano'";
		}
		else
		{
			// Si es Fudat o Coeej o Brigada o Batallon o Fuerza de Tarea
			if (($v_unidad == "6") or ($v_unidad == "7") or ($v_unidad1 == "7") or ($v_unidad1 == "8") or ($v_unidad1 == "9"))
			{
				if ($estado2 == "P")
				{
					...
					if ($responsable == "")
					{
						$graba2 = "UPDATE cx_pla_inv SET estado='$estado1', usuario3='$valor', firma3='$v_fir', especial='$v_especial1' WHERE conse='$conse' AND ano='$ano'";
						$graba5 = "UPDATE cx_pla_fir SET estado='$estado1', firma3='$firma' WHERE solicitud='$conse' AND ano='$ano'";
					}
					else
					{
						...
						else
						{
							...
							else
							{
								if ($estado2 == "S")
								{
									...
									$graba5 = "UPDATE cx_pla_fir SET estado='$estado1', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
								}
								else
								{
									$estado1 = $estado;
									...
									else
									{
										if ($estado2 == "M")
										{
											...
											$graba5 = "UPDATE cx_pla_fir SET estado='O', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
										}
										else
										{
											if ($estado2 == "O")
											{
												if ($valor == "SPG_DIADI")
												{
													...
													$graba5 = "UPDATE cx_pla_fir SET estado='L', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
												}
												else
												{
													if ($v_especial == "1")
													{
														...
														if ($valida2 == "SGA")
														{
															...
															$graba5 = "UPDATE cx_pla_fir SET estado='W', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
														}
														else
														{
															$graba2 = "UPDATE cx_pla_inv SET estado='T', usuario13='$valor', firma7='$v_fir' WHERE conse='$conse' AND ano='$ano'";
															$graba5 = "UPDATE cx_pla_fir SET estado='T', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
														}
													}
													else
													{
											...
											else
											{
												if ($v_especial == "1")
												{
													if ($estado2 == "T")
													{
														...
														$graba5 = "UPDATE cx_pla_fir SET estado='U', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
													}
													else
													{
														if ($estado2 == "U")
														{
															...
															$graba5 = "UPDATE cx_pla_fir SET estado='V', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
														}
														else
														{
															if ($estado2 == "V") 
															...
															else
															{
																if ($estado2 == "B")
																{
																	...
																	$graba5 = "UPDATE cx_pla_fir SET estado='C', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
																}
																else
																{
																	$graba2 = "UPDATE cx_pla_inv SET estado='B', usuario7='$valor', firma7='$v_fir' WHERE conse='$conse' AND ano='$ano'";
																	$graba5 = "UPDATE cx_pla_fir SET estado='B', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
																}
															}
														}
													}
														...
														if ($estado1 == "C")
														{
															...
															else
															{
																...
																else
																{
																	...
																	$graba5 = "UPDATE cx_pla_fir SET estado='$estado1', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
																}
															}
														}
														else
							...
							else
							{
								if ($estado2 == "J")
								{
									if (($valor == "JEM_CAIMI") or ($valor == "JEM_CACIM"))
									{
										...
										$graba5 = "UPDATE cx_pla_fir SET estado='K', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
									}
									else
									{
										if ($valor == "SPG_DIADI")
										{
											...
											$graba5 = "UPDATE cx_pla_fir SET estado='L' WHERE solicitud='$conse' AND ano='$ano'";
										}
										else
										{
											$graba2 = "UPDATE cx_pla_inv SET estado='K', usuario8='$valor', firma6='$v_fir' WHERE conse='$conse' AND ano='$ano'";
											$graba5 = "UPDATE cx_pla_fir SET estado='K', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
										}
									}
								}
								else
									...
									if ($estado2 == "K")
									{
										...
										else
										{
											...
											else
											{
												...
												$graba5 = "UPDATE cx_pla_fir SET estado='I', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
											}
										}
									}
									else
														...
														if ($v_recurso == "1")
														{
															if (($v_usuario2 == "RIN") or ($v_usuario2 == "SAT"))
															{
																if ($estado2 == "D")
																{
																	...
																	$graba5 = "UPDATE cx_pla_fir SET estado='E', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
																}
																else
																{
																	if ($estado2 == "E")
																...
																else
																{
																	if ($valor == "STE_DIADI")
																	{
																		...
																		else
																		{
																			...
																			$graba5 = "UPDATE cx_pla_fir SET estado='J', firma7='$firma' WHERE solicitud='$conse' AND ano='$ano'";
																		}
																	}
																	else
																	{
																		$graba2 = "UPDATE cx_pla_inv SET estado='J', usuario7='$valor', firma6='$v_fir' WHERE conse='$conse' AND ano='$ano'";
																		$graba5 = "UPDATE cx_pla_fir SET estado='J', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
																	}
																}
															}
														}
		   		...
		   		if ($valida2 == "CDO")
		        {
		        	if ($v_especial1 == "1")
		        	{
		        		if ($adm_usuario == "11")
		        		{
							...
							$graba5 = "UPDATE cx_pla_fir SET estado='A', firma6='$firma' WHERE solicitud='$conse' AND ano='$ano'";
						}
						else
						{
			        		if ($adm_usuario == "12")
								...
								else
								{
									if ($v_especial == "1")
									{
										...
										else
										{
											...
											$graba5 = "UPDATE cx_pla_fir SET estado='$estado1', firma8='$firma' WHERE solicitud='$conse' AND ano='$ano'";
										}
									}
									else
									{
	...
	$sql5 = odbc_exec($conexion, $graba5);
	//
	...
	else
	{
		...
		if ($adm_usuario == "7")
		{
			if ($estado == "D")
			{
		    	...
		    	$mensaje1 = "SE HA APROBADO EL PLAN / SOLICITUD CON EL NUMERO ".$conse."&nbsp;&nbsp;&nbsp;".$link1."<br><br>";
		    	$mensaje1 .= "SE SOLICITA VISTO BUENO DE LA ORDENACION &nbsp;&nbsp;&nbsp;".$visto1."<br><br>";
				$cur2 = odbc_exec($conexion,"SELECT isnull(max(conse),0)+1 AS conse FROM cx_notifica");
				$consecu1 = odbc_result($cur2,1);
				$query4 = "INSERT INTO cx_notifica (conse, usuario, unidad, usuario1, unidad1, mensaje, tipo, visto) VALUES ('$consecu1', '$usu_usuario', '$uni_usuario', '$usuario1', '$unidad1', '$mensaje1', '$estado', '1')";
				$sql4 = odbc_exec($conexion,$query4);
