              ...
              <div id="datos">
                ...
                <div class="row">
                  ...
                  <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    ...
                    <input type="text" name="reviso" id="reviso" class="form-control" value="" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="35" autocomplete="off">
                  </div>
                </div>
                <br>
                <center>
...
function calculo3(valor)
{
  ...
  {
    var valor4 = valor1.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
    var detalle = "<center><h3>Valor Aprobado no permitido, superior a "+valor4+"</h3></center>";
  ...
  if (valor6 > 0)
  {
    var detalle = "<center><h3>Valor Aprobado no permitido, superior a "+valor8+"</h3></center>";
    $("#dialogo").html(detalle);
    $("#dialogo").dialog("open");
    $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
    var actualiza = $("#actu").val();
