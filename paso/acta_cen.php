              ...
              <div id="datos">
                ...
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="sintesis" id="sintesis" class="form-control" rows="5" onblur="val_caracteres('sintesis');" tabindex="14"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-10 col-sm-10 col-md-10 col-xs-10">
                    ...
                    <textarea name="informacion" id="informacion" class="form-control" rows="5" onblur="val_caracteres('informacion');" tabindex="15"></textarea>
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <label><font face="Verdana" size="2">Valoraci&oacute;n</font></label>
                    <input type="text" name="total7" id="total7"  class="form-control numero" value="0.00" onkeyup="paso_valor4();" tabindex="16"><input type="hidden" name="total8" id="total8" class="form-control numero" value="0" readonly="readonly" tabindex="17">
                  </div>
                </div>
                <br>
                <div id="l_neutraliza">
                  ...
                  <div class="row">
                    <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                      ...
                      <div class="espacio1"></div>
                      <a href="#" name="add_field1" id="add_field1"><img src="imagenes/boton1.jpg" border="0" tabindex="18"></a>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                      <input type="text" name="total1" id="total1"  class="form-control numero" value="0.00" readonly="readonly" tabindex="19">
                      <input type="hidden" name="total2" id="total2" class="form-control numero" value="0" readonly="readonly" tabindex="20">
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                      ...
                      <textarea name="valoracion" id="valoracion" class="form-control" rows="5" onblur="val_caracteres('valoracion');" tabindex="21"></textarea>
                    </div>
                  </div>
                  <hr>
                </div>
                ...
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <div class="espacio1"></div>
                    <a href="#" name="add_field2" id="add_field2"><img src="imagenes/boton1.jpg" border="0" tabindex="22"></a>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    ...
                    <input type="text" name="cal_mat" id="cal_mat"  class="form-control numero" value="0.00" readonly="readonly" tabindex="23">
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <center><label><div class="centrado"><font face="Verdana" size="2">V/R M&Aacute;XIMO</font></div></label></center>
                    <input type="text" name="cal_mat1" id="cal_mat1"  class="form-control numero" value="0.00" readonly="readonly" tabindex="24">
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <center><label><div class="centrado"><font face="Verdana" size="2">DIFERENCIA</font></div></label></center>
                    <input type="text" name="cal_mat2" id="cal_mat2"  class="form-control numero" value="0.00" readonly="readonly" tabindex="25">
                  </div>
                  <div class="col col-lg-1 col-sm-1 col-md-1 col-xs-1">
                    ...
                    <input type="text" name="cal_mat3" id="cal_mat3"  class="form-control numero" value="0.00" readonly="readonly" tabindex="26">
                  </div>
                </div>
                <br>
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <input type="text" name="total3" id="total3"  class="form-control numero" value="0.00" readonly="readonly" tabindex="27"><input type="hidden" name="total4" id="total4" class="form-control numero" value="0" readonly="readonly" tabindex="28">
                  </div>
                </div>
                <hr>
                <hr>
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <input type="text" name="total5" id="total5"  class="form-control numero" value="0.00" readonly="readonly" tabindex="29"><input type="hidden" name="total6" id="total6" class="form-control numero" value="0" readonly="readonly" tabindex="30">
                  </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="impacto" id="impacto" class="form-control" rows="5" onblur="val_caracteres('impacto');" tabindex="31"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="concepto" id="concepto" class="form-control" rows="5" onblur="val_caracteres('concepto');" tabindex="32"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="aprobacion" id="aprobacion" class="form-control" rows="5" onblur="val_caracteres('aprobacion');" tabindex="33"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="observaciones" id="observaciones" class="form-control" rows="5" onblur="val_caracteres('observaciones');" tabindex="34"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    ...
                    <input type="text" name="elaboro" id="elaboro" class="form-control" value="<?php echo $nom_usuario; ?>" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="35" autocomplete="off">
                  </div>
                  <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                ...
                <br>
                <center>
                  <input type="button" name="aceptar" id="aceptar" value="Continuar" tabindex="37">
                  <input type="button" name="aceptar2" id="aceptar2" value="Actualizar" tabindex="38">
                  &nbsp;&nbsp;&nbsp;
                  <input type="button" name="aceptar1" id="aceptar1" value="Visualizar" tabindex="39">
                  &nbsp;&nbsp;&nbsp;
                  <input type="button" name="aceptar3" id="aceptar3" value="Cargar Acta Firmada" tabindex="40">
                </center>
              </div>
            </form>
          </div>
...
function validacionData()
{
  ...
  if (t_infor > 0)
  {
    ...
    {
      salida = false;
      detalle += "<center><h3>Debe ingresar la Valoraci&oacute;n de la Informaci&oacute;n</h3></center>";
  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='9%'><b>Acta</b></td><td height='35' width='8%'><b>Fecha</b></td><td height='35' width='8%'><b>Unidad</b></td><td height='35' width='10%'><b>Registro</b></td><td height='35' width='10%'><b>A&ntilde;o</b></td><td height='35' width='15%'><b>ORDOP / Frangmentaria</b></td><td height='35' width='10%'><center><b>Solicitado</b></center></td><td height='35' width='10%'><center><b>Valor Acta</b></center></td><td width='5%' height='35'>&nbsp;</td><td width='5%' height='35'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td></tr></table>";
