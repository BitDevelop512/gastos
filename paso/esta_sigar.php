      ...
      success: function (data)
      {
        ...
        if (consulta == "10")
        {
          ...
          if (total > 0)
          {
            ...
            salida += "<tr>";
            salida += "<td width='40%' height='35' bgcolor='#2E90BD'><center><b>Unidad</b></center></td>";
            ...
            for (var i=0; i<var_ocu1-1; i++)
            {
              ...
              total6 = formatNumber(total3);
              salida += "<tr>";
              salida += "<td width='40%' height='35'>"+var1+"</td>";
              ...
              salida += "</tr>";
              v_var1 += var1+"|"+var5+"|"+var7+"|"+var9+"|#";
            }
            v_var1 += "TOTAL|"+total1+"|"+total2+"|"+total3+"|#";
            salida += "<tr><td width='40%' height='35'><b>TOTAL:</b></td><td width='20%' height='35' align='right'><b>"+total4+"</b></td><td width='20%' height='35' align='right'><b>"+total5+"</b></td><td width='20%' height='35' align='right'><b>"+total6+"</b></td></tr>";
            salida += "</table>";
            $("#paso_excel").val(v_var1);
            $("#resultados9").append(salida);
          }
