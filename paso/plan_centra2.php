            ...
            <form name="formu" method="post">
              <div class="row">
                ...
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <center>
                    <br>
                    <a href="#" id="clip" onclick="subir(); return false;"><img src="dist/img/pdf1.png" title="Plan Centralizado Firmado"></a>
                  </center>
                </div>
              </div>
            </form>
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      if (salida == "1")
      {
        $("#clip").show();
        ruta = ruta+"\\fpdf\\pdf\\";
        var url = "cxvisor1/Default?valor1="+ruta+"\\&valor2="+link+"&valor3=0&valor4=0";
