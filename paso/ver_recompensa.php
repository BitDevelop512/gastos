...
else
{
	...
	if ($informe == "1")
	{
		$archivo = "ActaPagFue_".trim($sig_usuario)."_".$conse."_".$ano.".pdf";
	}
	else
	{
		$archivo = "ActaAntCor_".trim($sig_usuario)."_".$conse."_".$ano.".pdf";
	}
	...
	else
	{
		...
		{
			$pdf = "./".$fpdf."/605.php?conse=".$conse."&ano=".$ano."&registro=".$registro."&ano1=".$ano1."&ajuste=".$ajuste."&hoja=".$hoja;	
		}
	}
?>
<html lang="es">
