...
$objPHPExcel->getActiveSheet()->getStyle('A1:T1')->getFill()->getStartColor()->setARGB('CCCCCC');
...
$objPHPExcel->getActiveSheet()->getStyle('A1:T1')->applyFromArray($BStyle);
...
for ($i=0;$i<count($paso1)-1;++$i)
{
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A'.$j.':T'.$j)->applyFromArray($BStyle);
...
$objPHPExcel->getActiveSheet()->setTitle('Recursos Formalizados');
$objPHPExcel->setActiveSheetIndex(0);
header('Content-Type: application/vnd.ms-excel');
header('Content-Disposition: attachment;filename="RecursosFormalizados.xlsx"');
