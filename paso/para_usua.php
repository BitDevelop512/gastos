...
else
{
  ...
  $query = "SELECT nombre, ciudad, cedula, cargo, admin, unidad, email, conse FROM cx_usu_web WHERE usuario='$usu_usuario'";
      ...
      <form name="formu" method="post">
        ...
        <div id="firmas">
          ...
          <div class="row">
            ...
            <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
              <input type="text" name="firma1" id="firma1" class="form-control" value="<?php echo $n_firma1; ?>" onblur="javascript:this.value=this.value.toUpperCase();" tabindex="12" autocomplete="off">
            </div>
            <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
              <label><font face="Verdana" size="2">Grado - Nombre:</font></label>
            </div>
            <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
              <input type="text" name="firma2" id="firma2" class="form-control" value="<?php echo $n_firma2; ?>" onblur="javascript:this.value=this.value.toUpperCase();" tabindex="14" autocomplete="off">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
              <input type="text" name="cargo1" id="cargo1" class="form-control" value="<?php echo $n_cargo1; ?>" onblur="javascript:this.value=this.value.toUpperCase();" tabindex="13" autocomplete="off">
            </div>
            <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
              <label><font face="Verdana" size="2">Cargo:</font></label>
            </div>
            <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
              <input type="text" name="cargo2" id="cargo2" class="form-control" value="<?php echo $n_cargo2; ?>" onblur="javascript:this.value=this.value.toUpperCase();" tabindex="15" autocomplete="off">
            </div>
          </div>
          <br>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
              <input type="text" name="firma3" id="firma3" class="form-control" value="<?php echo $n_firma3; ?>" onblur="javascript:this.value=this.value.toUpperCase();" tabindex="16" autocomplete="off">
            </div>
          </div>
          <div class="espacio1"></div>
          <div class="row">
            ...
            <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
              <input type="text" name="cargo3" id="cargo3" class="form-control" value="<?php echo $n_cargo3; ?>" onblur="javascript:this.value=this.value.toUpperCase();" tabindex="17" autocomplete="off">
            </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col col-lg-5 col-sm-5 col-md-5 col-xs-5">
            ...
            <input type="hidden" name="text" id="text" class="form-control" value="https://soporte.cxcomputers.com/gastos/gastos.php?v1=<?php echo $con_firm; ?>&v2=<?php echo $usu_firm; ?>&v3=<?php echo $nom_firm; ?>" readonly="readonly" tabindex="1" />
...
function trae_firma()
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      {
        var detalle = "<center><h3>Firma No Registrada</h3></center>";
        $("#dialogo").html(detalle);
        $("#dialogo").dialog("open");
        $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
      }
