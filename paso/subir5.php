...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Plan Centralizado <?php echo $unidad." - ".$periodo1." / ".$ano; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/centralizado/".$ano."/".$unidad."/".$periodo1."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload5.php?periodo=<?php echo $periodo1; ?>&ano=<?php echo $ano; ?>&unidad=<?php echo $unidad; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
