...
if (is_ajax())
{
	...
	if ($estado == "Y")
	{
		...
		while($i<$row=odbc_fetch_array($cur))
		{
			...
			$mensaje = "<br>SU PLAN / SOLICITUD CON EL NUMERO ".$conse2." HA SIDO RECHAZADO(A) POR: ".$motivo."<br><br>";
	...
	if ($estado == "B")
	{
		...
		if ($adm_usuario == "7")
		{
			$mensaje = "<br>SE HA REVISADO EL PLAN CONSOLIDADO NUMERO ".$consecu." DE ".$ano."&nbsp;&nbsp;&nbsp;".$nom_pdf1."<br><br>";
		}
		else
		{        
			$mensaje = "<br>SE HA GENERADO EL PLAN CONSOLIDADO NUMERO ".$consecu." DE ".$ano."&nbsp;&nbsp;&nbsp;".$nom_pdf1."<br><br>";
		}
...
// 30/09/2024 - Ajuste grabacion firmas
// 07/11/2024 - Ajuste firmas
?>