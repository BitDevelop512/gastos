...
if (is_ajax())
{
  ...
  $query0 = "SELECT tipo FROM cx_usu_web WHERE ((usuario='$usu_usuario') OR (usuario='$log_usuario'))";
  ...
  $query1 = "SELECT total FROM cx_gas_bas WHERE ordop='$ordop' AND n_ordop='$mision5' AND mision='$mision1' AND numero='$interno' AND unidad='$uni_usuario' AND periodo IN ('$periodo','$periodo1','$periodo2') AND ano='$ano' AND ((usuario='$usu_usuario') OR (usuario='$log_usuario')) AND solicitud='$mision2'";
  ...
  if ($contador1 == "0")
  {
    ...
    $query1 = "SELECT total FROM cx_gas_bas WHERE ordop='$ordop' AND n_ordop='$mision5' AND mision LIKE '%$mision_m' AND numero='$interno' AND unidad='$uni_usuario' AND periodo='$periodo' AND ((usuario='$usu_usuario') OR (usuario='$log_usuario')) AND ano='$ano' AND solicitud='$mision2'";
    $sql1 = odbc_exec($conexion,$query1);
    $contador1 = odbc_num_rows($sql1);
  	if ($contador1 == "0")
  	{
		...
		$ordop_n = $ordop_n[0];
  		$query1 = "SELECT total FROM cx_gas_bas WHERE ordop LIKE '$ordop_n%' AND n_ordop='$mision5' AND mision='$mision1' AND numero='$interno' AND unidad='$uni_usuario' AND periodo='$periodo' AND ((usuario='$usu_usuario') OR (usuario='$log_usuario')) AND ano='$ano' AND solicitud='$mision2'";
    	$sql1 = odbc_exec($conexion,$query1);
    	$contador1 = odbc_num_rows($sql1);
    }
  }
...
// 23/05/2024 - Validacion suma de planillas
