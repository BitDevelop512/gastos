      ...
      <div id="lbl0">
        <table width="350" align="center" border="0">
          <tr>
            ...
            <td>
              <input type="text" name="usuario" id="usuario" maxlength="30" placeholder="Digite su usuario" onchange="javascript:this.value=this.value.toUpperCase();" autocomplete="off" required>
            </td>
          </tr>
        </table>
      </div>
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      else
      {
        if (salida == "2")
        {
          var detalle = "<font face='Verdana' size='3'>Proceso No Válido</font>";
          alerta(detalle);
        }
      }
    }
  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        if (valida == "0")
        {
          detalle1 = "<font face='Verdana' size='3'>Verifique los datos ingresados</font>";
          alerta(detalle1);
        }
        else
        {
          enviar();
          detalle1 = "<font face='Verdana' size='3'>Enviando correo de recuperaci&oacute;n de contrase&ntilde;a</font>";
          alerta1(detalle1);
        }
      }
    });
...
// 23/08/2024 - Ajuste envio correo recuperacion
// 03/09/2024 - Ajuste campo usuario a 30 caracteres 
?>