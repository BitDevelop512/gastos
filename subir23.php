...
else
{
  ...
  $alea = trim($_GET["alea"]);
  $ruta_local1 = $ruta_local."\\upload\\contratom";
...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Factura Mantenimiento Placa <?php echo $placa; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/contratom/".$placa."/".$fecha."/".$alea."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload23.php?alea=<?php echo $alea; ?>&fecha=<?php echo $fecha; ?>&placa=<?php echo $placa; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
