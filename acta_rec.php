  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='5%'><b>No.</b></td><td height='35' width='8%'><b>Fecha</b></td><td height='35' width='8%'><b>Unidad</b></td><td height='35' width='8%'><b>Usuario</b></td><td height='35' width='12%'><b>Registro - A&ntilde;o</b></td><td height='35' width='24%'><b>Fuentes</b></center></td><td height='35' width='10%'><b>Valor Acta</b></td><td height='35' width='5%'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td></tr></table>";
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          var datos2 = '\"'+value.conse+'\",\"'+value.ano+'\",\"'+value.registro+'\",\"'+value.ano1+'\",\"'+value.unidad+'\",\"'+var1+'\"';
          var datos3 = '\"'+value.conse+'\",\"'+value.ano+'\",\"'+value.registro+'\",\"'+value.ano1+'\",\"'+value.unidad+'\",\"'+var2+'\"';
          ...
          salida2 += "<td width='24%' height='35' id='l6_"+index+"'>"+value.cedulas+"</td>";
          salida2 += "<td width='10%' height='35' align='right' id='l7_"+index+"'>"+value.pago+"</td>";
          if ((periodo1 == mes) && (ano == ano1))
          {
            salida2 += "<td width='5%' height='35' id='l8_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); modif("+value.conse+","+value.ano+","+value.registro+","+value.ano1+")'><img src='imagenes/editar.png' border='0' title='Modificar'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='5%' height='35' id='l8_"+index+"'><center><img src='imagenes/blanco.png' border='0'></td>";
          }
          salida2 += "<td width='5%' height='35' id='l9_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link1("+datos2+")'><img src='imagenes/pdf.png' border='0' title='Visualizar Acta de Pago'></a></center></td>";
          salida2 += "<td width='5%' height='35' id='l10_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link1("+datos3+")'><img src='imagenes/pdf.png' border='0' title='Visualizar Acta de Acuerdos'></a></center></td>";
          // Eliminar PDF Final
          if (super1 == "1")
          {
            salida2 += "<td width='5%' height='35' id='l11_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); del_pdf("+datos1+");'><img src='dist/img/delete.png' name='pdf_"+index+"' id='pdf_"+index+"' width='29' height='29' border='0' title='Eliminar PDF Acta'></a></center></td><td width='5%' height='35' id='l12_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); del_pdf1("+datos1+");'><img src='dist/img/delete.png' name='pdf_"+index+"' id='pdf_"+index+"' width='29' height='29' border='0' title='Eliminar PDF Acuerdo'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='5%' height='35' id='l11_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td><td width='5%' height='35' id='l12_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          }
          salida2 += "</tr>";
          listareg.push(index);
        });
...
function del_pdf1(conse, ano, sigla, index)
{
  var conse, ano, index, archivo;
...
function link1(valor, valor1, valor2, valor3, valor4, valor5)
{
  ...
  $("#acta_hoja").val(hoja);
  $("#acta_sigla").val(valor4);
  $("#acta_informe").val(valor5);
  formu1.submit();
}
