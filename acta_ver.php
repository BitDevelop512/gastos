...
else
{
  ...
  $query = "SELECT (COUNT(1))+1 AS conse FROM cx_act_ver WHERE unidad='$uni_usuario' AND ano='$ano'";
  $sql = odbc_exec($conexion,$query);
  $consecu = odbc_result($sql,1);
  $consecu = str_pad($consecu,3,"0",STR_PAD_LEFT);
  $total = $ano."-".$consecu;
?>
<html lang="es">
<head>
            ...
            <form name="formu" method="post">
              <div class="row">
                <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                  ...
                  <input type="text" name="numero" id="numero" class="form-control numero" value="<?php echo $total; ?>" onkeypress="return check1(event);" onblur="verifica();" maxlength="30" tabindex="1" readonly="readonly">
              ...
              <div class="row">
                <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                  ...
                  <div class="espacio1"></div>
                  <input type="text" name="cargo" id="cargo" class="form-control" value="<?php echo $car_usuario; ?>" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="21" autocomplete="off">
                </div>
                <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                  <label><font face="Verdana" size="2">Revis&oacute;</font></label>
                  <input type="text" name="reviso" id="reviso" class="form-control" value="" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="22" autocomplete="off">
                  <div class="espacio1"></div>
                  <input type="text" name="cargo1" id="cargo1" class="form-control" value="" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="23" autocomplete="off">
                </div>
              </div>
              <br>
              <center>
          ...
          <div>
            ...
            <div class="row">
              <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                ...
                if ($sup_usuario == "1")
                {
                  $menu1_1 = odbc_exec($conexion,"SELECT DISTINCT centraliza FROM cx_act_ver WHERE centraliza!='' ORDER BY centraliza");
                }
                else
                {
...
$(document).ready(function () {
  ...
  $("#ajuste").width(50);
  $("#numero, #lugar, #unidad, #periodo, #plan").on("paste", function(e){
    e.preventDefault();
    alerta("Acción No Permitida");
  });
  $("#numero, #lugar, #unidad, #periodo, #plan").on("dragstart", function(e){
    e.preventDefault();
    alerta("Acción No Permitida");
  });
  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<br>";
        salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='10%'><b>Informe</b></td><td height='35' width='8%'><b>Fecha</b></td><td height='35' width='13%'><b>Lugar</b></td><td height='35' width='14%'><b>Unidad</b></td><td height='35' width='8%'><b>F. Inicio</b></td><td height='35' width='8%'><b>F. Termino</b></td><td height='35' width='14%'><center><b>Periodo</b></center></td><td width='5%' height='35'>&nbsp;</td><td width='5%' height='35'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td><td height='35' width='5%'>&nbsp;</td></tr></table>";
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          var datos1 = '\"'+value.conse+'\",\"'+value.ano+'\",\"'+value.acta+'\",\"'+index+'\"';
          salida2 += "<tr><td width='10%' height='35' id='l1_"+index+"'>"+value.acta+"</td>";
          salida2 += "<td width='8%' height='35' id='l2_"+index+"'>"+value.fecha+"</td>";
          salida2 += "<td width='13%' height='35' id='l3_"+index+"'>"+value.lugar+"</td>";
          salida2 += "<td width='14%' height='35' id='l4_"+index+"'>"+value.centraliza+"</td>";
          salida2 += "<td width='8%' height='35' id='l5_"+index+"'>"+value.fecha1+"</td>";
          salida2 += "<td width='8%' height='35' id='l6_"+index+"'>"+value.fecha2+"</td>";
          salida2 += "<td width='14%' height='35' id='l7_"+index+"'>"+value.periodo+"</td>";
          if (estado == "")
          {
            salida2 += "<td width='4%' height='35' id='l8_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); modif("+datos+")'><img src='imagenes/editar.png' border='0' title='Modificar'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='4%' height='35' id='l8_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          }
          salida2 += "<td width='4%' height='35' id='l9_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link1("+datos+")'><img src='imagenes/pdf.png' border='0' title='Visualizar Informe'></a></center></td>";
          if (estado !== "")
          {
            salida2 += "<td width='4%' height='35' id='l10_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link2("+datos+")'><img src='imagenes/pdf.png' border='0' title='Cargar Informe Firmado'></a></center></td>";
            salida2 += "<td width='4%' height='35' id='l11_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link4("+datos+")'><img src='imagenes/pdf.png' border='0' title='Visualizar Informe Firmado'></a></center></td>";
          }
          else
          {
          ...
          if (super1 == "1")
          {
            salida2 += "<td width='4%' height='35' id='l12_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); del_pdf("+datos1+");'><img src='dist/img/delete.png' name='pdf_"+index+"' id='pdf_"+index+"' width='29' height='29' border='0' title='Eliminar PDF'></a></center></td>";
          }
          else
          {
...
{
  var conse, ano, sigla, index, archivo;
  archivo = "ActaInfVer_"+sigla+"_"+conse+"_"+ano+".pdf";
...
function link4(valor, valor1, valor2)
{
  var valor, valor1, valor2;
  var informe = valor1+"_"+valor+"_"+valor2;
  var ruta = $("#ruta").val();
  ruta = ruta+"\\upload\\verificacion\\"+valor1+"_"+valor+"_"+valor2+"\\";
  var carpeta = $("#url").val();
  carpeta = carpeta+"upload/verificacion/"+informe+"/";
  var tipo = 1;
  $.ajax({
    type: "POST",
    datatype: "json",
    ...
    success: function (data)
    {
      ...
      if (archivo === null)
      {
        var detalle = "Acta No Encontrada o No Cargada";
        alerta(detalle);
      }
      else
      {
        var descarga = "1";
        var url = "cxvisor1/Default?valor1="+ruta+"&valor2="+archivo+"&valor3="+carpeta+"&valor4="+descarga;
...
// 30/01/2024 - Ajuste eliminacion de archivos pdf guardados
// 04/03/2024 - Ajusye inclusion filtro de uinidad para super usuario
// 01/08/2024 - Ajuste inclusion cargo reviso
// 01/11/2024 - Ajuste bloqueo pegado y drag
// 28/01/2025 - Ajuste numero de radicado automatico
// 04/02/2025 - Ajuste calculo contador
// 06/02/2025 - Ajuste inclusion boton visor
// 14/03/2025 - Ajuste consulta unidades
