  ...
  else
  {
    ...
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<div class='row'><div class='col col-lg-3 col-sm-3 col-md-3 col-xs-3'><input type='text' name='buscar' id='buscar' placeholder='Buscar...' class='form-control' autocomplete='off'></div><div class='col col-lg-9 col-sm-9 col-md-9 col-xs-9'></div></div>";
        salida1 += "<br>";
        if ((tipo == "1") || (tipo == "4"))
        {
        ...
        if ((tipo == "1") || (tipo == "3") || (tipo == "4"))
        {
          ...
          $.each(registros.rows, function (index, value)
          {
            ...
            {
              salida2 += "<tr>";
              salida2 += "<td height='35' width='10%' id='l1_"+index+"'>"+value.codigo+"</td>";
              salida2 += "<td height='35' width='30%' id='l2_"+index+"'>"+value.descripcion+"</td>";
              salida2 += "<td height='35' width='10%' id='l3_"+index+"'>"+value.fec_com+"</td>";
              salida2 += "<td height='35' width='10%' id='l4_"+index+"'>"+value.compania+"</td>";
              salida2 += "<td height='35' width='8%' id='l5_"+index+"'>"+value.unidad1+"</td>";
              salida2 += "<td height='35' width='14%' id='l6_"+index+"'><center>"+value.serial+"</center></td>";
              salida2 += "<td height='35' width='10%' id='l7_"+index+"' align='right'>"+value.valor+"</td>";
              salida2 += "<td height='35' width='8%' id='l8_"+index+"'><center>"+value.estado1+"</center></td>";
              salida2 += "</tr>";
            ...
            if (tipo == "3")
            {
              ...
              salida2 += "<tr>";
              salida2 += "<td height='35' width='10%' id='l1_"+index+"'>"+value.conse+"</td>";
              salida2 += "<td height='35' width='10%' id='l2_"+index+"'>"+value.fecha+"</td>";
              salida2 += "<td height='35' width='20%' id='l3_"+index+"'>"+value.codigos+"</td>";
              salida2 += "<td height='35' width='25%' id='l4_"+index+"'>"+value.tipo+"</td>";
              salida2 += "<td height='35' width='15%' id='l5_"+index+"'>"+value.tipo1+"</td>";
              salida2 += "<td height='35' width='10%' id='l6_"+index+"'>"+value.n_unidad+"</td>";
              salida2 += "<td height='35' width='5%' id='l7_"+index+"'>"+value.ano+"</td>";
              if (value.archivo > 0)
              {
                salida2 += "<td height='35' width='5%' id='l8_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",8); link1("+valida2+");'><img src='imagenes/pdf.png' border='0' title='Visualizar'></a></center></td></td>";
              }
              else
              {
                salida2 += "<td height='35' width='5%' id='l8_"+index+"'>&nbsp;</td></td>";
              }
              salida2 += "</tr>";
              listareg.push(index);
            }
...
// 06/02/2025 - Ajuste consulta actas cargadas
?>