...
$query0 = "SELECT conse, ano FROM cv_rev_pla WHERE unidad!='999' AND (usuario2='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='P') OR (usuario3='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='Q') OR (usuario4='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado IN ('A','Y','R') AND (usuario5='' OR usuario6='')) OR (usuario5='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado IN ('B','S') AND (usuario6='' OR usuario7='')) OR (usuario6='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado IN ('A','C','Y') AND (usuario7='' OR usuario8='')) OR (usuario7='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado IN ('B','J')) OR (usuario7='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='D' AND (usuario8='' OR usuario9='')) OR (usuario7='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='K' AND usuario8='' AND usuario9='') OR (usuario8='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado IN ('C','K') AND (usuario9='' OR usuario10='')) OR (usuario8='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='E' AND (usuario9='' OR usuario10='')) OR (usuario9='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='T' AND usuario10='') OR (usuario9='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='I' AND usuario10='' AND usuario11='') OR (usuario10='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='M') OR (usuario10='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='T') OR (usuario11='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='N') OR (usuario12='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='O') OR (usuario13='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='T') OR (usuario14='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='U') OR (usuario15='$usu_usuario' AND tipo='2' AND ano='$ano1' AND estado='V') ORDER BY conse";
