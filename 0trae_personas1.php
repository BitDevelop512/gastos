...
if (is_ajax())
{
  ...
  //$file = fopen("log_jm2024.txt", "a");
  //fwrite($file, $interno." - ".$unidad." - ".$paso." - ".$paso1." - ".$paso2." - ".$paso3.PHP_EOL);
  //fclose($file);
  ...
  // Departamento - Direccion - Unidad Especial - Fuerza de Despliegue - Fudat o Coeej (6 - 7)
  ...
  if ($paso == "6")
  {
    if ($adm_usuario == "13")
    {
      ...
      if ($paso3 == "1")
      {
        $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='10'";
      }
      else
      {
        $query = "SELECT * FROM cx_usu_web WHERE admin='14' AND login='SPG_DIADI'";
      }      
    }
    else
    {
      ...
      {
        case '10':
          $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='11'";
          break;
        case '11':
          $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='12'";
          break;
        case '12':
          $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='13'";
          break;
        default:
  ...
  if ($paso == "7")
  {
    ...
    */
    if ($nun_usuario <= 3)
    {
      ...
      {
        case '7':
          $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='8'";
          break;
        case '8':
          $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='9'";
          break;
        case '9':
          //$query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='31'";
          break;
        default:
          $query = "SELECT * FROM cx_usu_web WHERE 1=2";
          break;
    ...
    else
    {
      if ($adm_usuario == "9")
      {
        ...
        if ($v5 > 3)
        {
          $pregunta2 = "SELECT sigla, subdependencia FROM cx_org_sub WHERE unidad='$v5' AND unic='1'";
        }
        else
        {
          $pregunta2 = "SELECT sigla, subdependencia FROM cx_org_sub WHERE unidad='$v5' AND unic='1'";
        ...
        {
          $query = "SELECT * FROM cx_usu_web WHERE unidad='$v6_1' AND admin='10'";
        }
      }
      else
      {
        ...
        {
          case '6':
            $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='7'";
            break;
          case '7':
            $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='9'";
            break;
  ...
  //$fec_log = date("d/m/Y H:i:s a");
  //$file = fopen("log_jm2024.txt", "a");
  //fwrite($file, $query." ".$nun_usuario." # A".PHP_EOL);
  //fclose($file);
  ...
  if ($paso == "8")
  {
    ...
    if ($paso1 == "1")
    {
      if ($nun_usuario > 3)
      {
        ...
        {
          case '1':
            $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='3'";
            break;
          default:
      ...
      {
        $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND tipo='$tip_usuario' AND admin='2'";
      }
    }
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            case '3':
              $query = "SELECT * FROM cx_usu_web WHERE unidad='$uni_usuario' AND admin='4'";
              break;
            case '4':
              $query = "SELECT * FROM cx_usu_web WHERE unidad='$v6_1' AND admin='6'";
              break;
            default:
              $query = "SELECT * FROM cx_usu_web WHERE 1=2";        
              break;
