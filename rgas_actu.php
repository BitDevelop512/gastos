...
if (is_ajax())
{
	...
	$graba = "UPDATE cx_rel_gas SET responsable='$responsable', comandante='$comandante', elaboro='$elaboro', reviso='$reviso' WHERE conse='$conse' AND ano='$ano' AND unidad='$unidad'";
