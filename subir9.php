...
{
  $alea = $_GET["alea"];
  $ruta_local1 = $ruta_local."\\upload\\pqr";
  $carpeta1 = $ruta_local1;
  if(!file_exists($carpeta1))
  {
    mkdir ($carpeta1);
  }
  $carpeta2 = $carpeta1."\\".$alea;
...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Evidencia</font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload9.php?alea=<?php echo $alea; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
