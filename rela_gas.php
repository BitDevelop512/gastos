...
else
{
  ...
  $actual = date('Y-m-d');
  $query2 = "SELECT sigla, sigla1, fecha FROM cx_org_sub WHERE subdependencia='$uni_usuario'";
  $sql2 = odbc_exec($conexion, $query2);
  $sigla = trim(odbc_result($sql2,1));
  $sigla1 = trim(odbc_result($sql2,2));
  $fec_usuario = trim(odbc_result($sql2,3));
  if ($fec_usuario == "")
  {
  }
  else
              ...
              <div id="datos">
                ...
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    ...
                    <input type="hidden" name="valor1" id="valor1" class="form-control" onfocus="blur();" readonly="readonly">
                    <input type="hidden" name="valor2" id="valor2" class="form-control" onfocus="blur();" readonly="readonly">
                    <input type="hidden" name="valor3" id="valor3" class="form-control" onfocus="blur();" readonly="readonly">
                    <input type="hidden" name="centra" id="centra" class="form-control" value="<?php echo $unic; ?>" readonly="readonly">
                    <input type="hidden" name="paso_gasto" id="paso_gasto" class="form-control" value="0" readonly="readonly">
                    <input type="hidden" name="paso0" id="paso0" class="form-control" readonly="readonly">
                    ...
                    <input type="hidden" name="paso6" id="paso6" class="form-control" readonly="readonly">    <!-- Facturas Bienes -->
                    ...
                    <input type="hidden" name="paso9" id="paso9" class="form-control" readonly="readonly">    <!-- Factura Combustible -->
                    <input type="hidden" name="paso10" id="paso10" class="form-control" readonly="readonly">  <!-- Factura Grasas -->
                    <input type="hidden" name="paso11" id="paso11" class="form-control" readonly="readonly">  <!-- Factura Manteminiento -->
                    <input type="hidden" name="paso12" id="paso12" class="form-control" readonly="readonly">  <!-- Factura RTM -->
                    <input type="hidden" name="paso13" id="paso13" class="form-control" readonly="readonly">  <!-- Factura Llantas -->
                    <input type="hidden" name="paso14" id="paso14" class="form-control" readonly="readonly">  <!-- Repuestos -->
                    <input type="hidden" name="paso15" id="paso15" class="form-control" readonly="readonly">  <!-- Factura RTM Adicional -->
                    <input type="hidden" name="paso16" id="paso16" class="form-control" readonly="readonly">  <!-- Factura Combustible Ad -->
                    <input type="hidden" name="paso17" id="paso17" class="form-control" readonly="readonly">  <!-- Factura Llantas Ad -->
                    <input type="hidden" name="paso18" id="paso18" class="form-control" readonly="readonly">  <!-- Factura Mantemini Add -->
                    <input type="hidden" name="paso19" id="paso19" class="form-control" readonly="readonly">  <!-- IVA Manteminiento -->
                    <input type="hidden" name="paso20" id="paso20" class="form-control" readonly="readonly">  <!-- IVA Manteminiento Adicional -->
                    <input type="hidden" name="c_rtm" id="c_rtm" class="form-control" readonly="readonly">    <!-- Contador RTM -->
                    <input type="hidden" name="n_rtm" id="n_rtm" class="form-control" readonly="readonly">    <!-- Interno RTM -->
                    <input type="hidden" name="c_rtn" id="c_rtn" class="form-control" readonly="readonly">    <!-- Contador RTM Ad -->
                    <input type="hidden" name="n_rtn" id="n_rtn" class="form-control" readonly="readonly">    <!-- Interno RTM Ad -->
                    <input type="hidden" name="c_man" id="c_man" class="form-control" readonly="readonly">    <!-- Contador Mantenimientos -->
                    <input type="hidden" name="n_man" id="n_man" class="form-control" readonly="readonly">    <!-- Interno Mantenimientos -->
                    <input type="hidden" name="c_mam" id="c_mam" class="form-control" readonly="readonly">    <!-- Contador Manteni Ad -->
                    <input type="hidden" name="n_mam" id="n_mam" class="form-control" readonly="readonly">    <!-- Interno Manteni Ad -->
                    <input type="hidden" name="c_com" id="c_com" class="form-control" readonly="readonly">    <!-- Contador Combustible -->
                    <input type="hidden" name="n_com" id="n_com" class="form-control" readonly="readonly">    <!-- Interno Combustible -->
                    <input type="hidden" name="c_con" id="c_con" class="form-control" readonly="readonly">    <!-- Contador Combust. Ad. -->
                    <input type="hidden" name="n_con" id="n_con" class="form-control" readonly="readonly">    <!-- Interno Combust. Ad. -->
                    <input type="hidden" name="c_lla" id="c_lla" class="form-control" readonly="readonly">    <!-- Contador Llantas -->
                    <input type="hidden" name="n_lla" id="n_lla" class="form-control" readonly="readonly">    <!-- Interno Llantas -->
                    <input type="hidden" name="v_pla" id="v_pla" class="form-control" readonly="readonly">    <!-- Gasolina placas con sop -->
                    <input type="hidden" name="v_pla1" id="v_pla1" class="form-control" readonly="readonly">  <!-- Gasolina placas sin sop -->
                    <input type="hidden" name="v_pla2" id="v_pla2" class="form-control" readonly="readonly">  <!-- Gasolina placas ad con sop-->
                    <input type="hidden" name="v_pla3" id="v_pla3" class="form-control" readonly="readonly">  <!-- Gasolina placas ad sin sop -->
                    <input type="hidden" name="c_gas" id="c_gas" class="form-control" value="0" readonly="readonly">        <!-- Contador Gastos -->
                    <input type="hidden" name="v_36" id="v_36" class="form-control numero" value="0" readonly="readonly">   <!-- Combustible Solicitado -->
                    <input type="hidden" name="v_42" id="v_42" class="form-control numero" value="0" readonly="readonly">   <!-- Combustible Adicional Solicitado -->
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      for (var i=0; i<var_ocu1-1; i++)
      {
        ...
        {
          p2 = combustible1;
          var v_com_sol = $("#v_36").val();
          if (combustible1 == v_com_sol)
          {
          }
          else
          {
            sal_com = false;
            var det_com = "<center><h3><font color='#3333ff'>Valor Combustible Solicitado: "+v_com_sol+"</font></h3></center><center><h3><font color='#ff0000'>Valor Combustible Registrado: "+combustible1+"</font></h3></center>";
          }
        }
        if (p1 == "42")
        {
          p2 = combustible3;
          var v_com_sol = $("#v_42").val();
          if (combustible3 == v_com_sol)
          {
          }
          else
          {
            sal_com = false;
            var det_adi = "<center><h3><font color='#3333ff'>Valor Combustible Adicional Solicitado: "+v_com_sol+"</font></h3></center><center><h3><font color='#ff0000'>Valor Combustible Adicional Registrado: "+combustible3+"</font></h3></center>";
          }
        }
        $("#vag_"+z).val(p2);
        $("#del_"+z).hide();
      ...
      {
        $("#aceptar").hide();
        var detalle = "<center><h3>No se encontro el Valor Aprobado de la Misión. El Informe de Autorización no ha sido generado</h3></center>";
        $("#dialogo").html(detalle);
        $("#dialogo").dialog("open");
        $("#dialogo").closest('.ui-dialog').find('.ui-dialog-titlebar-close').hide();
        $("#valor").val('0.00');
      ...
      else
      {
        if (sal_com == false)
        {
          if (det_com == undefined)
          {
            det_com = "";
          }
          if (det_adi == undefined)
          {
            det_adi = "";
          }
          var det_fin = det_com+det_adi;
          //$("#aceptar").hide();
          $("#dialogo9").html(det_fin);
...
function pregunta1()
{
  ...
  var detalle = "<center><h3><font color='#3333ff'>TOTAL GASTOS CON SOPORTES: "+con_fac+"</font></h3></center><center><h3><font color='#ff0000'>TOTAL GASTOS SIN FACTURAS: "+sin_fac+"</font></h3></center><center><h3>Esta seguro de continuar ?</h3></center>";
      ...
      for (var i=0; i<var_ocu1-1; i++)
      {
        ...
        var p3 = var_2[2];
      	...
      	p4 = p4.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
            ...
            {
              if (jQuery.inArray(p3, lis_placa) != -1)
              {
              }
              else
              {
...
function link()
{
  ...
  var valor1 = $("#tipo").val();
  var valor2 = $("#n_ano").val();
  var valor3 = $("#periodo").val();
  var valor4 = $("#v_unidad").val();
  var valor5 = $("#sigla").val();
  $("#plan_conse").val(valor);
  $("#plan_tipo").val(valor1);
  $("#plan_ano").val(valor2);
  $("#plan_periodo").val(valor3);
  $("#plan_unidad").val(valor4);
  $("#plan_sigla").val(valor5);
  formu3.submit();
}
function link1(valor, tipo, ano, periodo, unidad, sigla)
{
  var valor, tipo, ano, periodo, unidad;
  $("#plan_conse").val(valor);
  $("#plan_tipo").val(tipo);
  $("#plan_ano").val(ano);
...
function modif(valor, tipo, ano, unidad, index)
{
  var valor, tipo, ano, unidad, index;
  $.ajax({
    type: "POST",
    datatype: "json",
    url: "rela_consu2.php",
    ...
    success: function (data)
    {
      ...
      var cargo1 = registros.cargo;
      var reviso = registros.reviso;
      var cargo2 = registros.cargo1;
...
function del_pdf(conse, tipo, ano, sigla, index)
{
  ...
  if (tipo == "1")
  {
    archivo = "RelGas_"+sigla+"_"+conse+"_"+ano+".pdf";
  }
  else
  {
    archivo = "InfGas_"+sigla+"_"+conse+"_"+ano+".pdf";
  }
  var ruta = "Relaciones\\"+ano+"\\"+archivo;
  $.ajax({
    type: "POST",
    datatype: "json",
    url: "borrar2.php",
...
function des_rel(conse, ano, periodo, unidad)
{
  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='5%'><b>No.</b></td><td height='35' width='8%'><b>Fecha</b></td><td height='35' width='8%'><b>Unidad</b></td><td height='35' width='8%'><b>Usuario</b></td><td height='35' width='23%'><b>Ordop</b></td><td height='35' width='13%'><b>Misi&oacute;n</b></td><td height='35' width='10%'><b>Total</b></td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td></tr></table>";
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          var datos1 = '\"'+value.conse+'\",\"'+tipo1+'\",\"'+value.ano+'\",\"'+value.unidad+'\",\"'+index+'\"';
          var datos2 = '\"'+value.conse+'\",\"'+tipo1+'\",\"'+value.ano+'\",\"'+value.periodo+'\",\"'+value.unidad1+'\",\"'+value.unidad+'\"';
          ...
          salida2 += "<td width='23%' height='35' id='l5_"+index+"'>"+value.ordop+"</td>";
          salida2 += "<td width='13%' height='35' id='l6_"+index+"'>"+value.mision+"</td>";
          salida2 += "<td width='10%' height='35' id='l7_"+index+"' align='right'>"+value.total+"</td>";
          salida2 += "<td width='4%' height='35' id='l8_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); link1("+datos2+")'><img src='imagenes/pdf.png' border='0' title='Visualizar'></a></center></td>";
          salida2 += "<td width='4%' height='35' id='l9_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); link2("+datos+")'><img src='dist/img/factura.png' width='25' height='25' border='0' title='Facturas'></a></center></td>";
          // Contingencia
          if (servidor == "C")
          {
            salida2 += "<td width='4%' height='35' id='l10_"+index+"'><center><img src='dist/img/server.png' width='25' height='25' border='0' title='Contingencia'></center></td>";
          }
          else
          {
          ...
          if (super1 == "1")
          {
            salida2 += "<td width='4%' height='35' id='l11_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); modif("+value.conse+","+tipo1+","+value.ano+","+value.unidad1+","+index+")'><img src='dist/img/editar.png' name='act_"+index+"' id='act_"+index+"' width='27' height='27' border='0' title='Modificar'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='4%' height='35' id='l11_"+index+"'>&nbsp;</td>";
          }
          if (super1 == "1")
          {
            salida2 += "<td width='4%' height='35' id='l12_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); des_rel("+value.conse+","+value.ano+","+value.periodo+","+value.unidad1+");'><img src='dist/img/download.png' width='32' height='32' border='0' title='Descargar'></a></center></td>";
          }
          else
          {
          	salida2 += "<td width='4%' height='35' id='l12_"+index+"'>&nbsp;</td>";
          }
          // Eliminar PDF Final
          if (super1 == "1")
          {
...
// Combustible a otros vehiculos
function agrega42(valor)
{
  var InputsWrapper = $("#add_form4 table tr");
  var x = InputsWrapper.length;
  var FieldCount = 1;
  if(x <= 999)
  {
    ...
    var alea = $("#alea").val();
    FieldCount++;
    $("#add_form4 table").append('<tr><td colspan="9" class="espacio1"><center><font face="Verdana" size="3"><b>Datos de Combustible</b></font></center></td></tr><td width="15%" class="espacio1"><label><font face="Verdana" size="2">Clase</font></label><input type="text" name="com1_'+y+'" id="com1_'+y+'" class="form-control" readonly="readonly"></td><td width="1%">&nbsp;</td><td width="12%" class="espacio1"><label><font face="Verdana" size="2">Placa</font></label><input type="text" name="com2_'+y+'" id="com2_'+y+'" class="form-control" value= "'+valor+'" readonly="readonly"></td><td width="1%">&nbsp;</td><td width="20%"><label><font face="Verdana" size="2">Valor</font></label><input type="text" name="com3_'+y+'" id="com3_'+y+'" class="form-control numero" onkeyup="paso_valc('+y+'); suma4();"><input type="hidden" name="com4_'+y+'" id="com4_'+y+'" class="form-control numero" value="0" readonly="readonly"></td><td width="1%">&nbsp;</td><td width="40%"><label><font face="Verdana" size="2">Detalles</font></label><input type="text" name="com5_'+y+'" id="com5_'+y+'" class="form-control" value="Movimiento de Combustible" readonly="readonly"><input type="hidden" name="alec_'+y+'" id="alec_'+y+'" class="form-control numero" value="'+alea+'_'+y+'" readonly="readonly"></td><td width="1%">&nbsp;</td><td width="9%" align="right"><label><font face="Verdana" size="2">Factura</font></label><br><a href="#" name="lnkc_'+y+'" id="lnkc_'+y+'" onclick="cargac('+y+');"><img src="imagenes/clip.png" border="0" title="Anexar Factura"></a></td></tr><tr><td colspan="9"><hr></td></tr>');
    x++;
    $("#com3_"+y).maskMoney();
    $("#com1_"+y).prop("disabled",true);
    $("#com2_"+y).prop("disabled",true);
  ...
  for (i=0;i<document.formu6.elements.length;i++)
  {
    ...
    if (saux15.indexOf('man16_')!=-1)
    {
      ...
      else
      {
        ...
        {
          salida = false;
          $("#"+saux15).addClass("ui-state-error");
        }
      }
    }
    saux16 = document.formu6.elements[i].name;
    if (saux16.indexOf('man17_')!=-1)
    {
      ...
      else
      {
        ...
        {
          salida = false;
          $("#"+saux16).addClass("ui-state-error");
        }
      }
    }
    ...
    if (saux21.indexOf('man19_')!=-1)
    {
      ...
      else
      {
        ...
        {
          salida = false;
          $("#"+saux21).addClass("ui-state-error");
        }
      }
    }
...
// 27/10/2023 - Ajuste inclusion kilometraje en relacion de gastos
// 30/11/2023 - Ajuste Llantas
// 01/12/2023 - Ajuste validacion kilometraje y bloqueo pegado
// 28/12/2023 - Ajuste retiro de validacion de kilometraje
// 26/01/2024 - Eliminacion de archivos pdf guardados
// 06/02/2024 - Envio de unidad
// 22/02/2024 - Ajuste envio sigla generacion pdf
// 29/02/2024 - Ajuste para bienes en valor 0
// 04/03/2024 - Inclusion filtro de uinidad para super usuario
// 05/08/2024 - Ajuste inclusion cargo elaboro
// 02/09/2024 - Ajuste validacion sigla
// 16/10/2024 - Ajuste consulta misiones nombre repetido
// 23/10/2024 - Ajuste retiro cargo elaboro y reviso
// 07/11/2024 - Ajuste validacion combustible solicitado
// 22/11/2024 - Ajuste identificador contingencia
// 12/02/2025 - Ajuste bienes valor no superior al solicitado
// 14/03/2025 - Ajuste DINCI unidad centralizadora
