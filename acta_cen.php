...
else
{
  ...
  $consu = "SELECT conse, ano FROM cx_reg_rec WHERE usuario4='$usu_usuario' AND estado='E' AND NOT EXISTS(SELECT * FROM cx_act_cen WHERE cx_act_cen.registro=cx_reg_rec.conse AND cx_act_cen.ano1=cx_reg_rec.ano) ORDER BY conse";
  ...
  <section class="content-header">
    <div class="row">
      <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <div id="soportes">
          <h3>Acta Comit&eacute; Central Recompensas</h3>
          <div>
            <form name="formu" method="post">
              <div class="row">
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  ...
                  <input type="hidden" name="v_material" id="v_material" class="form-control" value="" readonly="readonly">
                  <input type="hidden" name="v_niveles" id="v_niveles" class="form-control" value="" readonly="readonly">
                  ...
                  <input type="hidden" name="v_paso3" id="v_paso3" class="form-control" value="" readonly="readonly">
                ...
                <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                  <label><font face="Verdana" size="2">Valor Aprobado CR</font></label>
              ...
              <div id="datos">
                ...
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <label><font face="Verdana" size="2">Fec. Acta Manual</font></label>
                    <input type="text" name="fec_act" id="fec_act" class="form-control fecha" placeholder="yy/mm/dd" readonly="readonly" tabindex="11">
                  </div>
                  <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                    ...
                    <input type="text" name="constancia" id="constancia" onkeypress="return check1(event);" class="form-control numero" value="" maxlength="30" tabindex="12" autocomplete="off">
                  </div>
                  <div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
                    <label><font face="Verdana" size="2">Folio(s) Acta(s) Pago Previo</font></label>
                    <input type="text" name="folio" id="folio" onkeypress="return check2(event);" class="form-control numero" value="0" maxlength="30" tabindex="13" autocomplete="off">
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <label><font face="Verdana" size="2">Valor Anticipo</font></label>
                    <input type="text" name="total9" id="total9"  class="form-control numero" value="0.00" onkeyup="paso_valor5();" tabindex="14"><input type="hidden" name="total10" id="total10" class="form-control numero" value="0" readonly="readonly" tabindex="15">
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <label><font face="Verdana" size="2">Al efecto se procede como a continuaci&oacute;n se relaciona</font></label>
                    <textarea name="sintesis" id="sintesis" class="form-control" rows="5" onblur="val_caracteres('sintesis');" tabindex="16"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-10 col-sm-10 col-md-10 col-xs-10">
                    ...
                    <textarea name="informacion" id="informacion" class="form-control" rows="5" onblur="val_caracteres('informacion');" tabindex="17"></textarea>
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <label><font face="Verdana" size="2">Valoraci&oacute;n</font></label>
                    <input type="text" name="total7" id="total7"  class="form-control numero" value="0.00" onkeyup="paso_valor4();" tabindex="18"><input type="hidden" name="total8" id="total8" class="form-control numero" value="0" readonly="readonly" tabindex="19">
                  </div>
                </div>
                <br>
                <div id="l_neutraliza">
                  ...
                  <div class="row">
                    <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                      ...
                      <div class="espacio1"></div>
                      <a href="#" name="add_field1" id="add_field1"><img src="imagenes/boton1.jpg" border="0" tabindex="20"></a>
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    ...
                    <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                      <input type="text" name="total1" id="total1"  class="form-control numero" value="0.00" readonly="readonly" tabindex="21">
                      <input type="hidden" name="total2" id="total2" class="form-control numero" value="0" readonly="readonly" tabindex="22">
                    </div>
                  </div>
                  <br>
                  <div class="row">
                    <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                      ...
                      <textarea name="valoracion" id="valoracion" class="form-control" rows="5" onblur="val_caracteres('valoracion');" tabindex="23"></textarea>
                    </div>
                  </div>
                  <hr>
                </div>
                ...
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <div class="espacio1"></div>
                    <a href="#" name="add_field2" id="add_field2"><img src="imagenes/boton1.jpg" border="0" tabindex="24"></a>
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    ...
                    <input type="text" name="cal_mat" id="cal_mat"  class="form-control numero" value="0.00" readonly="readonly" tabindex="25">
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <center><label><div class="centrado"><font face="Verdana" size="2">V/R M&Aacute;XIMO</font></div></label></center>
                    <input type="text" name="cal_mat1" id="cal_mat1"  class="form-control numero" value="0.00" readonly="readonly" tabindex="26">
                  </div>
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <center><label><div class="centrado"><font face="Verdana" size="2">DIFERENCIA</font></div></label></center>
                    <input type="text" name="cal_mat2" id="cal_mat2"  class="form-control numero" value="0.00" readonly="readonly" tabindex="27">
                  </div>
                  <div class="col col-lg-1 col-sm-1 col-md-1 col-xs-1">
                    ...
                    <input type="text" name="cal_mat3" id="cal_mat3"  class="form-control numero" value="0.00" readonly="readonly" tabindex="28">
                  </div>
                </div>
                <br>
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <input type="text" name="total3" id="total3"  class="form-control numero" value="0.00" readonly="readonly" tabindex="29"><input type="hidden" name="total4" id="total4" class="form-control numero" value="0" readonly="readonly" tabindex="30">
                  </div>
                </div>
                <hr>
                <hr>
                <div class="row">
                  ...
                  <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
                    <input type="text" name="total5" id="total5"  class="form-control numero" value="0.00" readonly="readonly" tabindex="31"><input type="hidden" name="total6" id="total6" class="form-control numero" value="0" readonly="readonly" tabindex="32">
                  </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="impacto" id="impacto" class="form-control" rows="5" onblur="val_caracteres('impacto');" tabindex="33"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <label><font face="Verdana" size="2">Concepto de Evaluaci&oacute;n del Comit&eacute; Central</font></label>
                    <textarea name="concepto" id="concepto" class="form-control" rows="5" onblur="val_caracteres('concepto');" tabindex="34"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <label><font face="Verdana" size="2">Aprobaci&oacute;n de Pago</font></label>
                    <textarea name="aprobacion" id="aprobacion" class="form-control" rows="5" onblur="val_caracteres('aprobacion');" tabindex="35"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    ...
                    <textarea name="observaciones" id="observaciones" class="form-control" rows="5" onblur="val_caracteres('observaciones');" tabindex="36"></textarea>
                  </div>
                </div>
                <br>
                <div class="row">
                  <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    ...
                    <input type="text" name="elaboro" id="elaboro" class="form-control" value="<?php echo $nom_usuario; ?>" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="37" autocomplete="off">
                    <div class="espacio1"></div>
                    <input type="text" name="cargo" id="cargo" class="form-control" value="<?php echo $car_usuario; ?>" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="38" autocomplete="off">
                  </div>
                  <div class="col col-lg-6 col-sm-6 col-md-6 col-xs-6">
                    <label><font face="Verdana" size="2">Revis&oacute;</font></label>
                    <input type="text" name="reviso" id="reviso" class="form-control" value="" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="39" autocomplete="off">
                    <div class="espacio1"></div>
                    <input type="text" name="cargo1" id="cargo1" class="form-control" value="" onchange="javascript:this.value=this.value.toUpperCase();" maxlength="120" tabindex="40" autocomplete="off">
                  </div>
                </div>
                <br>
                <center>
                  <input type="button" name="aceptar" id="aceptar" value="Continuar" tabindex="41">
                  <input type="button" name="aceptar2" id="aceptar2" value="Actualizar" tabindex="42">
                  &nbsp;&nbsp;&nbsp;
                  <input type="button" name="aceptar1" id="aceptar1" value="Visualizar" tabindex="43">
                  &nbsp;&nbsp;&nbsp;
                  <input type="button" name="aceptar3" id="aceptar3" value="Cargar Acta Firmada" tabindex="44">
                </center>
              </div>
            </form>
          </div>
...
function calculo1(valor)
{
  ...
  if (valor3 > 0)
  {
    ...
    var detalle = "Valoración no permitida, superior a "+valor4;
    alerta(detalle);
  }
  suma();
}
...
function calculo3(valor)
{
  ...
  {
    var valor4 = valor1.toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
    var detalle = "Valor Aprobado no permitido, superior a "+valor4;
    alerta(detalle);
  }
  ...
  if (valor6 > 0)
  {
    var detalle = "Valor Aprobado no permitido, superior a "+valor8;
    alerta(detalle);
  }
  suma1();
}
...
function suma2()
{
  ...
  var valor3 = (valor0+valor1+valor2)-(valora);
  $("#total6").val(valor3);
...
function paso_valor5()
{
  var valor = $("#total9").val();
  valor = parseFloat(valor.replace(/,/g,''));
  $("#total10").val(valor);
  suma2();
}
...
function pregunta1()
{
  var detalle = "<center><h3><font color='#ff0000'>El Acta no podrá ser modificada.</font><br>Esta seguro de continuar ?</h3></center>";
...
function pregunta2()
{
  var detalle = "<center><h3>Valor del Acta Superior al Valor Aprobado CR.<br>Esta seguro de continuar ?</h3></center>";
...
function validacionData()
{
  ...
  {
    salida = false;
    detalle += "<center><h3>Debe ingresar "+v_valoracion+" Valoración(es)</h3></center>";
  }
  var v_elementos = 0;
  for (i=0;i<document.formu.elements.length;i++)
  {
  ...
  {
    salida = false;
    detalle += "<center><h3>Debe ingresar la Constancia</h3></center>";
  ...
  {
    salida = false;
    detalle += "<center><h3>Debe ingresar al Efecto se Procede</h3></center>";
  ...
  var t_infor = $("#total8").val();
  t_infor = parseFloat(t_infor);
  if (t_infor > 0)
  {
    var valor0 = $("#informacion").val();
    valor0 = valor0.trim().length;
    if (valor0 == "0")
    {
      salida = false;
      detalle += "<center><h3>Debe ingresar la Valoración de la Información</h3></center>";
      $("#informacion").addClass("ui-state-error");
    }
    else
    {
      $("#informacion").removeClass("ui-state-error");
    }
  }
  ...
  if (t_neutra > 0)
  {
    ...
    {
      salida = false;
      detalle += "<center><h3>Debe ingresar la Valoración de Neutralizados</h3></center>";
  ...
  {
    salida = false;
    detalle += "<center><h3>Debe ingresar el Concepto de Evaluación</h3></center>";
  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='7%'><b>Acta</b></td><td height='35' width='8%'><b>Fecha</b></td><td height='35' width='8%'><b>Unidad</b></td><td height='35' width='8%'><b>Registro</b></td><td height='35' width='8%'><b>A&ntilde;o</b></td><td height='35' width='15%'><b>ORDOP / Fragmentaria</b></td><td height='35' width='10%'><center><b>Solicitado Unidad</b></center></td><td height='35' width='10%'><center><b>Valor Comit&eacute; Reg.</b></center></td><td height='35' width='10%'><center><b>Valor Acta</b></center></td><td width='4%' height='35'>&nbsp;</td><td width='4%' height='35'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td></tr></table>";
        ...
        $.each(registros.rows, function (index, value)
        {
          ...
          salida2 += "<tr><td width='7%' height='35' id='l1_"+index+"'>"+value.conse+"</td>";
          salida2 += "<td width='8%' height='35' id='l2_"+index+"'>"+value.fecha+"</td>";
          salida2 += "<td width='8%' height='35' id='l3_"+index+"'>"+value.unidad+"</td>";
          salida2 += "<td width='8%' height='35' id='l4_"+index+"'>"+value.registro+"</td>";
          salida2 += "<td width='8%' height='35' id='l5_"+index+"'>"+value.ano1+"</td>";
          salida2 += "<td width='15%' height='35' id='l6_"+index+"'>"+value.ordop+" "+value.fragmenta+"</td>";
          salida2 += "<td width='10%' height='35' id='l7_"+index+"' align='right'>"+value.solicitado+"</td>";
          salida2 += "<td width='10%' height='35' id='l8_"+index+"' align='right'>"+value.valor+"</td>";
          salida2 += "<td width='10%' height='35' id='l9_"+index+"' align='right'>"+value.totala+"</td>";
          if (estado == "")
          {
            salida2 += "<td width='4%' height='35' id='l10_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); modif("+value.conse+","+value.ano+","+value.registro+","+value.ano1+")'><img src='imagenes/editar.png' border='0' title='Modificar'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='4%' height='35' id='l10_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          }
          salida2 += "<td width='4%' height='35' id='l11_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); link1("+datos1+")'><img src='imagenes/pdf.png' border='0' title='Visualizar Acta'></a></center></td>";
          if ((estado == "E") || (estado == "F") || (estado == "G"))
          {
            salida2 += "<td width='4%' height='35' id='l12_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); link2("+value.conse+","+value.ano+","+codigo+")'><img src='imagenes/pdf.png' border='0' title='Visualizar Acta Firmada'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='4%' height='35' id='l12_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          }
          // Eliminar PDF Final
          if (super1 == "1")
          {
            salida2 += "<td width='4%' height='35' id='l13_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",13); del_pdf("+datos1+");'><img src='dist/img/delete.png' name='pdf_"+index+"' id='pdf_"+index+"' width='29' height='29' border='0' title='Eliminar PDF'></a></center></td>";
          }
          else
          {
            salida2 += "<td width='4%' height='35' id='l13_"+index+"'><center><img src='imagenes/blanco.png' border='0'></center></td>";
          }
          salida2 += "</tr>";
          listareg.push(index);
        });
...
function modif(valor, valor1, valor2, valor3)
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      $("#aprobacion").val(registros.aprobacion);
      ...
      var anticipo = registros.anticipo;
      $("#total9").val(anticipo);
      paso_valor3('total9','total10');
      var totaln = registros.totaln;
      $("#total1").val(totaln);
      paso_valor3('total1','total2');
      var totalm = registros.totalm;
...
function del_pdf(conse, ano, sigla, index)
{
  ...
  archivo = "ActaComCen_"+sigla+"_"+conse+"_"+ano+".pdf";
...
{
  var alea = $("#alea").val();
  var url = "<a href='./subir11.php?alea="+alea+"' name='link3' id='link3' class='pantalla-modal'>Link</a>";
  $("#vinculo").hide();
  $("#vinculo").html('');
  $("#vinculo").append(url);
...
// 09/02/2024 - Ajuste retiro de estado OPTIMO por NUEVO y adicion N/A en material
// 16/02/2024 - Ajuste inclusion campo cargo en la organizacion delincuencial
// 26/02/2024 - Ajuste envio sigla generacion pdf
// 02/05/2024 - Ajuste inclusion columna valor solicitado por unidad
