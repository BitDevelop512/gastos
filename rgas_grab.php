...
if (is_ajax())
{
	...
	else
	{
		...
		if ($v_fecha1 == $v_fecha2)
		{
			...
			fwrite($file, $fec_log." # ".$v_fecha1." # ".$v_fecha2." # ".$consu." # ".$usu_usuario." # ".PHP_EOL);
			fclose($file);
		}
		else
		{
			...
			if ($confirma == "1")
			{
				...
				for ($k=0;$k<(count($num_bien1)-1);++$k)
				{
					...
					else
					{
						...
						fwrite($file, $fec_log." # ".$graba3." # ".$usu_usuario." # ".PHP_EOL);
						fwrite($file, $fec_log." # ".$informacion." # ".$usu_usuario." # ".PHP_EOL);
