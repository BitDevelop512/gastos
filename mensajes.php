      ...
      <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
        <div id="soportes">
          ...
          <div>
            ...
            <form name="formu5" action="ver_info.php" method="post" target="_blank">
...
function link4(ano, periodo, concepto, unidad, archivo, conse)
{
  var ano, periodo, concepto, unidad, archivo, conse;
  var ruta = $("#ruta").val();
  var url = $("#url").val();
  if ((concepto == "ADICIONAL") || (concepto == "RECOMPENSAS"))
  {
    var carpeta = url+"upload/informe/"+ano+"/"+periodo+"/"+concepto+"/"+unidad+"/"+conse+"/";
  }
  else
  {
    var carpeta = url+"upload/informe/"+ano+"/"+periodo+"/"+concepto+"/"+unidad+"/";
  }
  var descarga = "1";
  if ((concepto == "ADICIONAL") || (concepto == "RECOMPENSAS"))
  {
    var url1 = "cxvisor1/Default?valor1="+ruta+"\\upload\\informe\\"+ano+"\\"+periodo+"\\"+concepto+"\\"+unidad+"\\"+conse+"\\&valor2="+archivo+"&valor3="+carpeta+"&valor4="+descarga;
  }
  else
  {
    var url1 = "cxvisor1/Default?valor1="+ruta+"\\upload\\informe\\"+ano+"\\"+periodo+"\\"+concepto+"\\"+unidad+"\\&valor2="+archivo+"&valor3="+carpeta+"&valor4="+descarga;
  }
  $("#paso_url").val(url1);
  formu5.submit();
}
  ...
  if (valor1 == "2")
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        {
          var detalle = "<h3><center>Aprobación Ya Registrada</center></h3>";
    ...
    $.ajax({
      ...
      success: function (data)
      {
        ...
        if (confirma == "1")
        {
          ...
          var detalle = "<h3><center>Notificación Enviada a: "+notifica+"</center></h3>";
        }
        else
        {
          var detalle = "<h3><center>Aprobación Ya Registrada</center></h3>";
...
// Version 2
function mensaje3(valor, valor1, valor2)
{
  var valor, valor1, valor2;
  if (valor1 == "2")
  {
...
// 06/08/2024 - Ajuste notificacion al cargar informe de giro firmado
// 30/10/2024 - Ajuste notificaciones version 2
// 21/01/2025 - Ajuste inclusion icono cambio de valor
