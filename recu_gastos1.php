    ...
    if ($tipo == "1")
    {
        ...
        if ($total>0)
        {
            ...
            while ($i < $row = odbc_fetch_array($sql))
            {
                ...
                $pregunta1 = "SELECT valor, bienes, gasto, (SELECT nombre FROM cx_ctr_pag WHERE cx_ctr_pag.codigo=cx_pla_gad.gasto) AS n_gasto FROM cx_pla_gad WHERE conse1='$conse' AND ano='$ano' AND gasto IN ($conceptos) ORDER BY gasto";
                ...
                while ($l < $row1 = odbc_fetch_array($sql1))
                {
                    ...
                    if (($gasto1 == "36") or ($gasto1 == "42"))
                    {
                        ...
                        for ($k=0;$k<count($val_bie4)-1;++$k)
                        {
                            ...
                            $valores .= $conse."|".$placa."|".$clase."|".$valor."|".$detalle."|".$n_unidad."|".$usuario."|".$fecha."|".$periodo."|".$kilometraje."|".$ordop1."|".$mision1."|".$numero."|".$consecu."|".$otros."|".$gasto1."|".$unidad1."|".$kilometraja."|".$gasto2."|".$tpcombus1."|".$cantidad."|#";
                        }
                        $valida = "1";
                    }
/*
    ...
    if ($tipo == "2")
    {
        ...
        if ($total>0)
        {
            ...
            while ($i < $row = odbc_fetch_array($sql))
            {
                ...
                $mes = str_pad($periodo,2,"0",STR_PAD_LEFT);
                $pregunta1 = "SELECT valor, datos, gasto FROM cx_rel_dis WHERE conse1='$conse' AND consecu='$consecu' AND ano='$ano' AND gasto IN ($conceptos)";
                $sql1 = odbc_exec($conexion, $pregunta1);
                $l = 0;
                while ($l < $row = odbc_fetch_array($sql1))
                {
                    ...
                    if ($valida == "0")
                    {
                        ...
                        $valores .= $conse."|".$placa."|".$clase."|".$valor."|".$detalle."|".$n_unidad."|".$usuario."|".$fecha."|".$periodo."|".$kilometraje."|".$ordop."|".$mision."|".$numero."|".$consecu."|".$otros."|".$gasto1."|".$unidad1."|".$kilometraja."|".$gasto2."|".$tpcombus1."|".$cantidad."|#";
                    }
                    $l++;
                }
                $i++;
