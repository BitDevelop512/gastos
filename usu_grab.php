...
if (is_ajax())
{
	...
	$query = "INSERT INTO cx_usu_web (conse, usuario, nombre, clave, permisos, conexion, estado, cambio, unidad, admin, super, usu_crea, login) VALUES ('$consecu', '$usuario', '$nombre', '$clave', '$permisos', '2', '1', '1', '0', '0', '$clase', '$usu_usuario', '$usuario')";
...
// 21/02/2024 - Ajuste grabacion permisos y clasde superusuario
?>