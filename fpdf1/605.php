...
else
{
	...
	$consulta0 = "select * from cx_org_sub where sigla = '".$_SESSION["sig_usuario"]."'";
	$cur0 = odbc_exec($conexion,$consulta0);
	$n_unidad = $_SESSION["sig_usuario"]." - ".trim(odbc_result($cur0,6));
	...
	$consulta = "select * from cx_act_rec where conse = '".$_GET['conse']."' and ano = '".$_GET['ano']."'";
	...
	$nom_pdf="../fpdf/pdf/Actas/ActaComAntiCor_".trim($usu_usuario)."_".$_GET['conse']."_".$_GET['ano'].".pdf";
