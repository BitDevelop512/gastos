...
else
{
	...
	$consulta = "select * from cx_con_ban where unidad = '".$_SESSION["uni_usuario"]."' and periodo = '".$_GET['periodo']."' and ano = '".$ano."'";
	...
	{
		$fecha_n1 = $n_diasmes[$per-1]."/".$per."/".$ano;
	}	
