...
else
{
	...
	class PDF extends PDF_Rotate
	{
		function Header()
		{
			...
			$this->SetFont('Arial','',8);
			$this->Cell(36,5,'FO-JEMPP-CEDE2-638-3',0,1,'');
		...
		function Footer()
		{
  			...
  			$this->Cell(190,4,'SIGAR 3 - '.$fecha1,0,1,'');
  			$this->Ln(-4);
  			$this->SetFont('Arial','B',8);
  			$this->SetTextColor(255,150,150);
  			$this->Cell(190,5,'SECRETO',0,1,'C');
...
*/
	...
	$nom_pdf="../fpdf/pdf/PlanInvCenEsp_".trim($var_uni1)."_".$_GET['conse']."_".$_GET['periodo']."_".$_GET['ano'].".pdf";
