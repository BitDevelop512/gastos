...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Cuenta Gastos Reservados <?php echo $sigla." - ".$periodo." / ".$ano; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/cuenta/".$ano."/".$periodo."/".$sigla."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload14.php?sigla=<?php echo $sigla; ?>&periodo=<?php echo $periodo; ?>&ano=<?php echo $ano; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
    ...
    onSelect: function(files)
    {
      ...
      if ((extension == "zip") || (extension == "ZIP") || (extension == "rar") || (extension == "RAR"))
      {
      }
      else
      {
        alerta1("Archivo '"+archivo+"' no válido para cargue de cuenta");
        return false;
      }
    },
