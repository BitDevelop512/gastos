  		...
  		<div class="row">
  			<div class="col col-lg-3 col-sm-3 col-md-3 col-xs-3">
  				...
  				<select name="tp_soporte" id="tp_soporte" class="form-control select2" onchange="verifica();" tabindex="1">
						...
						<option value="4">ACTUALIZACIÓN DE FECHAS INGRESOS</option>
  				</select>
  			</div>
...
<div class="box box-success">
  <div class="box-header with-border">
    <h3 class="box-title">Encriptador / Desencriptador</h3>
  </div>
  <div class="box-body">
    <div class="row">
      <div class="col col-lg-10 col-sm-10 col-md-10 col-xs-10">
        <textarea name="texto2" id="texto2" class="form-control" rows="6"></textarea>
      </div>
      <div class="col col-lg-2 col-sm-2 col-md-2 col-xs-2">
      	<br>
        <button type="button" name="boton2" id="boton2" onclick="encript(1);" class="btn btn-block btn-primary">
          <font face="Verdana" size="2">Encriptar</font>
        </button>
        <br>
        <button type="button" name="boton3" id="boton3" onclick="encript(2);" class="btn btn-block btn-primary">
          <font face="Verdana" size="2">Desencriptar</font>
        </button>
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col col-lg-12 col-sm-12 col-md-12 col-xs-12">
	      <textarea name="resultados1" id="resultados1" class="form-control" rows="6" readonly="readonly"></textarea>
	    </div>
    </div>
  </div>
</div>
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      if (tipo == "3")
      {
        var total = registros.total;
        var total1 = total-1;
        var actualiza = registros.actualiza;
        var salida = "";
        if (total>0)
        {
          salida += "<table width='100%' align='center' border='1' id='a-table1'>";
      ...
      if (tipo == "4")
      {
        ...
        {
         	salida += "<table width='100%' align='center' border='1' id='a-table1'>";
          salida += "<tr><td height='35' width='10%'><center><b>N&uacute;mero</b></center></td><td height='35' width='10%'><center><b>Fecha</b></center></td><td height='35' width='10%'><center><b>Hora</b></center></td><td height='35' width='10%'><center><b>Usuario</b></center></td><td height='35' width='10%'><center><b>Unidad</b></center></td><td height='35' width='5%'><center><b>Estado</b></center></td><td height='35' width='10%'><center><b>Periodo</b></center></td><td height='35' width='5%'><center><b>A&ntilde;o</b></center></td><td height='35' width='15%'><center><b>Valor</b></center></td><td height='35' width='10%'><center><b>Nueva Fecha</b></center></td><td height='35' width='5%'>&nbsp;</td></tr>";
          $.each(registros.rows, function (index, value)
          {
          	...
          	salida += "<tr>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='com_"+index+"' id='com_"+index+"' value='"+value.ingreso+"' class='form-control numero' readonly='readonly'></td>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='fec_"+index+"' id='fec_"+index+"' value='"+value.fecha+"' class='form-control fecha' readonly='readonly'></td>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='hor_"+index+"' id='hor_"+index+"' value='"+value.hora+"' class='form-control fecha' readonly='readonly'></td>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='usu_"+index+"' id='usu_"+index+"' value='"+value.usuario+"' class='form-control' readonly='readonly'></td>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='uni_"+index+"' id='uni_"+index+"' value='"+value.unidad+"' class='form-control' readonly='readonly'></td>";
    				salida += "<td height='45' width='5%' class='margen'><input type='text' name='est_"+index+"' id='est_"+index+"' value='"+value.estado+"' class='form-control fecha' readonly='readonly'></td>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='per_"+index+"' id='per_"+index+"' value='"+value.periodo+"' class='form-control numero' readonly='readonly'></td>";
    				salida += "<td height='45' width='5%' class='margen'><input type='text' name='ano_"+index+"' id='ano_"+index+"' value='"+value.ano+"' class='form-control numero' readonly='readonly'></td>";
    				salida += "<td height='45' width='15%' class='margen'><input type='text' name='val_"+index+"' id='val_"+index+"' value='"+valor+"' class='form-control numero' readonly='readonly'></td>";
    				salida += "<td height='45' width='10%' class='margen'><input type='text' name='dat_"+index+"' id='dat_"+index+"' class='form-control fecha' placeholder='yy/mm/dd'  readonly='readonly'></td>";
    				salida += "<td height='45' width='5%' class='margen'><center><img src='dist/img/grabar1.png' width='20' border='0' title='Actualizar Fecha Ingreso' class='cursor1' name='gra_"+index+"' id='gra_"+index+"' onclick='actu3("+index+");'></center></td>";
    				salida += "</tr>";
          });
          salida += "</table>";
          salida += "<input type='hidden' name='minimo' id='minimo' value='<?php echo $minimo; ?>' class='form-control' readonly='readonly'>";
          $("#resultados").append(salida);
					for (k=0;k<=10;k++)
          {
          	if ($("#dat_"+k).length)
...
function actu3(valor)
{
  var valor;
  var fecha = $("#fec_"+valor).val();
  var hora = $("#hor_"+valor).val();
  var fecha1 = $("#dat_"+valor).val();
  var unidad = $("#tp_unidad").val();
  var numero = $("#tp_numero").val();
  var ano = $("#tp_ano").val();
  if (fecha1 == "")
...
// 20/03/2025 - Ajuste inclusion encriptador / desencriptador
?>