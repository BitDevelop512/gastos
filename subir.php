...
else
{
  ...
  if ($tipo == "1")
  {
    $ruta_local1 = $ruta_local."\\upload\\cdp";
    $nombre = "CDP";
    $nombre1 = "cdp";
  }
  else
  {
    $ruta_local1 = $ruta_local."\\upload\\crp";
    $nombre = "CRP";
    $nombre1 = "crp";
  }
  $carpeta1 = $ruta_local1."\\".$carpeta;
...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000"><?php echo $nombre; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/".$nombre1."/".$carpeta."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload.php?tipo=<?php echo $tipo; ?>&conse=<?php echo $carpeta; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
