...
if (is_ajax())
{
	...
	if ($tipo == "3")
	{
		...
		if ($v_batallon == "BRIGADA")
		{
			...
			{
				// Estado Q
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='Q' AND usuario2='$usuario' AND usuario3='$usuario1' AND usuario4=''";
				...
				// Estado R
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='R' AND usuario3='$usuario' AND usuario4='$usuario1' AND usuario5=''";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
					// Actualización solicitud
					$graba = "UPDATE cx_pla_inv SET estado='Q', usuario4='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='R'";
					if (!odbc_exec($conexion, $graba))
					{
						$confirma = "0";
					}
				...
				// Estado S
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='S' AND usuario4='$usuario' AND usuario5='$usuario1' AND usuario6=''";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
					// Actualización solicitud
					$graba = "UPDATE cx_pla_inv SET estado='R', usuario5='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='S'";
					if (!odbc_exec($conexion, $graba))
					{
						$confirma = "0";
					}
					...
					{
						$confirma = "1";
						$graba1 = "DELETE FROM cx_pla_est WHERE conse='$conse' AND solicitud='$numero' AND ano='$ano' AND estado='R'";
						odbc_exec($conexion, $graba1);
						// Log
						$fec_log = date("d/m/Y H:i:s a");
						$file = fopen("log_soporte_solicitud.txt", "a");
				...
				// Estado A
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='A' AND ((usuario3='$usuario' AND usuario4='$usuario1' AND usuario5='') OR (usuario5='$usuario' AND usuario6='$usuario1' AND usuario7=''))";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
					$pregunta1 = "SELECT usuario3, usuario5 FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='A'";
					$sql1 = odbc_exec($conexion, $pregunta1);
					$val_usu1 = trim(odbc_result($sql1,1));
					$val_usu2 = trim(odbc_result($sql1,2));
					// Actualización solicitud
					if ($val_usu1 == $usuario)
					{
					...
					{
						$graba = "UPDATE cx_pla_inv SET estado='S', usuario6='', usuario7='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='A'";
					}
					if (!odbc_exec($conexion, $graba))
					{
						$confirma = "0";
					...
					{
						$confirma = "1";
						$graba1 = "DELETE FROM cx_pla_est WHERE conse='$conse' AND solicitud='$numero' AND ano='$ano' AND estado IN ('Q','S')";
						odbc_exec($conexion, $graba1);
						// Log
						$fec_log = date("d/m/Y H:i:s a");
						$file = fopen("log_soporte_solicitud.txt", "a");
				...
				// Estado B
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='B' AND ((usuario4='$usuario' AND usuario5='$usuario1' AND usuario6='') OR (usuario6='$usuario' AND usuario7='$usuario1' AND usuario8=''))";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
					$pregunta1 = "SELECT usuario4, usuario6 FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='B'";
					$sql1 = odbc_exec($conexion, $pregunta1);
					$val_usu1 = trim(odbc_result($sql1,1));
					$val_usu2 = trim(odbc_result($sql1,2));
					// Actualización solicitud
					if ($val_usu1 == $usuario)
					{
						$graba = "UPDATE cx_pla_inv SET estado='A', usuario5='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='B'";
					}
					else
					{
						$graba = "UPDATE cx_pla_inv SET estado='A', usuario7='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='B'";
					}
					if (!odbc_exec($conexion, $graba))
					{
						$confirma = "0";
				...
				// Estado C
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='C' AND usuario5='$usuario' AND usuario6='$usuario1' AND usuario7=''";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
				...
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='E' AND usuario6='$usuario' AND usuario8='$usuario1' AND usuario9=''";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
				...
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='J' AND usuario6='$usuario' AND usuario7='$usuario1' AND usuario8=''";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
				...
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='L' AND usuario7='$usuario' AND usuario8='$usuario1' AND usuario9=''";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
				...
				// Estado W
				$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W' AND ((usuario7='$usuario' AND usuario8='$usuario1' AND usuario9='') OR (usuario8='$usuario' AND usuario9='$usuario1' AND usuario10=''))";
				$sql = odbc_exec($conexion, $pregunta);
				$total = odbc_num_rows($sql);
				if ($total>0)
				{
					$pregunta1 = "SELECT usuario7, usuario8 FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W'";
					$sql1 = odbc_exec($conexion, $pregunta1);
					$val_usu1 = trim(odbc_result($sql1,1));
					$val_usu2 = trim(odbc_result($sql1,2));
					// Actualización solicitud
					if ($val_usu1 == $usuario)
					{
						$graba = "UPDATE cx_pla_inv SET estado='B', usuario8='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W'";

					}
					else
					{
						$graba = "UPDATE cx_pla_inv SET estado='E', usuario9='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W'";
					}
					...
					{
						$confirma = "1";
						$graba1 = "DELETE FROM cx_pla_est WHERE conse='$conse' AND solicitud='$numero' AND ano='$ano' AND estado IN ('B','E')";
						odbc_exec($conexion, $graba1);
						// Log
						$fec_log = date("d/m/Y H:i:s a");
						$file = fopen("log_soporte_solicitud.txt", "a");
		...
		if ($v_batallon == "BATALLON")
		{
			...
			{
				// Actualización solicitud
				$graba = "UPDATE cx_pla_inv SET estado='P', usuario3='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='Q'";
				if (!odbc_exec($conexion, $graba))
				{
					$confirma = "0";
				}
			...
			if ($total>0)
			{
				...
				if ($val_usu1 == $usuario)
				{
					$graba = "UPDATE cx_pla_inv SET estado='Q', usuario4='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='A'";
				}
				else
				{
					$graba = "UPDATE cx_pla_inv SET estado='S', usuario6='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='A'";
				}
				if (!odbc_exec($conexion, $graba))
				{
					$confirma = "0";
			...
			// Estado C
			$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='C' AND ((usuario5='$usuario' AND usuario6='$usuario1' AND usuario7='') OR (usuario7='$usuario' AND usuario8='$usuario1' AND usuario9=''))";
			$sql = odbc_exec($conexion, $pregunta);
			$total = odbc_num_rows($sql);
			if ($total>0)
			{
				$pregunta1 = "SELECT usuario5, usuario7 FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='C'";
				$sql1 = odbc_exec($conexion, $pregunta1);
				$val_usu1 = trim(odbc_result($sql1,1));
				$val_usu2 = trim(odbc_result($sql1,2));
				// Actualización solicitud
				if ($val_usu1 == $usuario)
				{
					$graba = "UPDATE cx_pla_inv SET estado='B', usuario6='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='C'";
				}
				else
				{
					$graba = "UPDATE cx_pla_inv SET estado='B', usuario8='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='C'";
				}
				if (!odbc_exec($conexion, $graba))
				{
					$confirma = "0";
			...
			// Estado D
			$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='D' AND usuario6='$usuario' AND usuario7='$usuario1' AND usuario8=''";
			$sql = odbc_exec($conexion, $pregunta);
			$total = odbc_num_rows($sql);
			if ($total>0)
			{
				// Actualización solicitud
				$graba = "UPDATE cx_pla_inv SET estado='C', usuario7='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='D'";
				if (!odbc_exec($conexion, $graba))
				{
					$confirma = "0";
				}
			...
			// Estado E
			$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='E' AND usuario7='$usuario' AND usuario8='$usuario1' AND usuario9=''";
			$sql = odbc_exec($conexion, $pregunta);
			$total = odbc_num_rows($sql);
			if ($total>0)
			{
				// Actualización solicitud
				$graba = "UPDATE cx_pla_inv SET estado='D', usuario8='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='E'";
				if (!odbc_exec($conexion, $graba))
				{
					$confirma = "0";
				}
				...
				{
					$confirma = "1";
					$graba1 = "DELETE FROM cx_pla_est WHERE conse='$conse' AND solicitud='$numero' AND ano='$ano' AND estado='D'";
					odbc_exec($conexion, $graba1);
					// Log
					$fec_log = date("d/m/Y H:i:s a");
					$file = fopen("log_soporte_solicitud.txt", "a");
			...
			// Estado W
			$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W' AND ((usuario8='$usuario' AND usuario9='$usuario1' AND usuario10='') OR (usuario12='$usuario' AND usuario13='$usuario1' AND usuario14=''))";
			$sql = odbc_exec($conexion, $pregunta);
			$total = odbc_num_rows($sql);
			if ($total>0)
			{
				$pregunta1 = "SELECT usuario8, usuario12, recurso FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W'";
				$sql1 = odbc_exec($conexion, $pregunta1);
				$val_usu1 = trim(odbc_result($sql1,1));
				$val_usu2 = trim(odbc_result($sql1,2));
				$val_recu = trim(odbc_result($sql1,3));
				// Actualización solicitud
				if ($val_usu1 == $usuario)
				{
					$graba = "UPDATE cx_pla_inv SET estado='E', usuario9='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W'";
				...
				{
					$graba = "UPDATE cx_pla_inv SET estado='O', usuario13='' WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='W'";
				}
				if (!odbc_exec($conexion, $graba))
				{
					$confirma = "0";
				...
				{
					$confirma = "1";
					$graba1 = "DELETE FROM cx_pla_est WHERE conse='$conse' AND solicitud='$numero' AND ano='$ano' AND estado IN ('E','O')";
					odbc_exec($conexion, $graba1);
					// Log
					$fec_log = date("d/m/Y H:i:s a");
					$file = fopen("log_soporte_solicitud.txt", "a");
			...
			$pregunta = "SELECT * FROM cx_pla_inv WHERE conse='$numero' AND ano='$ano' AND tipo='2' AND estado='O' AND usuario10='$usuario' AND usuario11='' AND usuario12='$usuario1' AND usuario13=''";
			$sql = odbc_exec($conexion, $pregunta);
			$total = odbc_num_rows($sql);
			if ($total>0)
			{
