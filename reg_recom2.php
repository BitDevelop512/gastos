            ...
            <form name="formu" method="post">
              ...
              <div class="row">
                ...
                <div class="col col-lg-4 col-sm-4 col-md-4 col-xs-4">
                  ...
                  $menu8 = "<select name='directiva' id='directiva' class='form-control select2' tabindex='28'>";
                  $i = 1;
...
function val_resultado()
{
  ...
  $.ajax({
    ...
    success: function (data)
    {
      ...
      {
        $("#aceptar").hide();
        var detalle = "<center><h3>Plazo m&aacute;ximo "+dias+" d&iacute;as h&aacute;biles vencido seg&uacute;n Directiva</h3></center>";
