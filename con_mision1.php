...
if (is_ajax())
{
  ...
  $pregunta1 = "SELECT *, (SELECT orden FROM cx_ctr_pag WHERE cx_ctr_pag.codigo=cx_pla_gad.gasto) AS orden FROM cx_pla_gad WHERE conse1 IN ($conse1) AND interno IN ($interno) AND unidad='$uni_usuario' AND ano='$ano' AND gasto!='1' ORDER BY orden";
  $sql1 = odbc_exec($conexion, $pregunta1);
  $total1 = odbc_num_rows($sql1);
  $contador1 = 0;
  $contador2 = 0;
  ...
  $pregunta3 = "SELECT total, responsable FROM cx_gas_bas WHERE ordop='$ordop' AND n_ordop='$var1' AND ".$pre_mis." AND numero IN ($var5) AND unidad='$uni_usuario' AND periodo IN ('$periodo','$periodo1') AND ano='$ano' AND ((usuario='$usu_usuario') OR (usuario='$log_usuario')) AND solicitud IN ($var4)";
  ...
  // Con soporte
  $pregunta4 = "SELECT total, soporte FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='1' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='1'";
  ...
  {
    $pregunta10 = "SELECT SUM(total) AS total, soporte, placa FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='1' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='1' GROUP BY placa, soporte";
    $sql10 = odbc_exec($conexion,$pregunta10);
    while($i<$row=odbc_fetch_array($sql10))
    {
      $v_pla1 = odbc_result($sql10,1);
      $v_pla2 = odbc_result($sql10,2);
      $v_pla3 = odbc_result($sql10,3);
      $val_placa .= $v_pla1."|".$v_pla2."|".$v_pla3."|#";
    }
  }
  // Sin soporte
  $pregunta6 = "SELECT total, soporte FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='1' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='0'";
  ...
  {
    $pregunta11 = "SELECT SUM(total) AS total, soporte, placa FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='1' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='0' GROUP BY placa, soporte";
    $sql11 = odbc_exec($conexion,$pregunta11);
    while($i<$row=odbc_fetch_array($sql11))
    {
      $v_pla1 = odbc_result($sql11,1);
      $v_pla2 = odbc_result($sql11,2);
      $v_pla3 = odbc_result($sql11,3);
      $val_placa1 .= $v_pla1."|".$v_pla2."|".$v_pla3."|#";
    }
  }
  // Kilometraje - adicional
  // Con soporte
  $pregunta5 = "SELECT total, soporte FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='2' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='1'";
  $sql5 = odbc_exec($conexion,$pregunta5);
  $tot_com2 = 0;
  ...
  {
    $pregunta12 = "SELECT SUM(total) AS total, soporte, placa FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='2' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='1' GROUP BY placa, soporte";
    $sql12 = odbc_exec($conexion,$pregunta12);
    while($i<$row=odbc_fetch_array($sql12))
    {
      $v_pla1 = odbc_result($sql12,1);
      $v_pla2 = odbc_result($sql12,2);
      $v_pla3 = odbc_result($sql12,3);
      $val_placa2 .= $v_pla1."|".$v_pla2."|".$v_pla3."|#";
    }
  }
  // Sin soporte
  $pregunta9 = "SELECT total, soporte FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='2' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='0'";
  ...
  {
    $pregunta13 = "SELECT SUM(total) AS total, soporte, placa FROM cv_tra_mov WHERE unidad='$uni_usuario' AND CONVERT(datetime,fecha,102) BETWEEN CONVERT(datetime,'$fecha1',102) AND CONVERT(datetime,'$lapso2',102) AND tipo='2' AND solicitud IN ($conse) AND ano='$ano' AND $var7 AND soporte='0' GROUP BY placa, soporte";
    $sql13 = odbc_exec($conexion,$pregunta13);
    while($i<$row=odbc_fetch_array($sql13))
    {
      $v_pla1 = odbc_result($sql13,1);
      $v_pla2 = odbc_result($sql13,2);
      $v_pla3 = odbc_result($sql13,3);
      $val_placa3 .= $v_pla1."|".$v_pla2."|".$v_pla3."|#";
    }
  }
  $salida = new stdClass();
  ...
  $salida->placas = $val_placa;
  $salida->placas1 = $val_placa1;
  $salida->placas2 = $val_placa2;
  $salida->placas3 = $val_placa3;
  echo json_encode($salida);
}
// 11/03/2024 - Ajuste para consulta de movimiento de combustible registro por por administrador
// 14/08/2024 - Ajuste en ordenamiento de gastos diferentes a gastos de participantes
