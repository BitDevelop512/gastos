...
if (is_ajax())
{
    ...
    $ano = $_POST['ano'];
    $unidad = $_POST['unidad'];
    $pregunta = "SELECT responsable, comandante, elaboro, reviso FROM cx_rel_gas WHERE conse='$valor' AND tipo='$tipo' AND ano='$ano' AND unidad='$unidad'";
...
// 05/08/2024 - Ajuste inclusion cargo reviso
