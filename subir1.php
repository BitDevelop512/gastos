...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">C&eacute;dula:&nbsp;<?php echo $carpeta; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/recompensas/".$alea."/".$carpeta."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload1.php?alea=<?php echo $alea; ?>&conse=<?php echo $carpeta; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
...
function cargar(valor)
{
  ...
  else
  {
    ...
    $("#imagen").html('');
    $("#imagen").append(image);
    $("div#imagen img").css({"width":"350px", "height":"350px"});
  }
}
