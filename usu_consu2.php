...
if (is_ajax())
{
	...
	$query = "SELECT * FROM cx_usu_web WHERE usuario LIKE '%$usuario%' ORDER BY nombre";
	$cur = odbc_exec($conexion, $query);
	$total = odbc_num_rows($cur);
	$salida = "<table width='100%' align='center' border='1' id='a-table1'><tr><td height='35' width='35%'><center><b>Nombre</b></center></td><td height='35' width='20%'><center><b>Usuario</b></center></td><td height='35' width='10%'><center>&nbsp</center></td><td height='35' width='10%'><center>&nbsp</center></td><td height='35' width='10%'><center>&nbsp</center></td><td height='35' width='10%'><center>&nbsp</center></td><td height='35' width='5%'><center><input type='text' name='opt' id='opt' class='form-control fecha' size='1' maxlength='1' onclick='marca1()' readonly='readonly'></center></td></tr>";
	$i = 0;
	while($i<$row=odbc_fetch_array($cur))
	{
		$conse = odbc_result($cur,1);
		$usuario = trim(odbc_result($cur,3));
		$nombre = utf8_encode(odbc_result($cur,4));
		...
		{
			$salida .= "<tr><td height='35'>".$nombre."</td><td height='35'>".$usuario."</td><td height='35'><center><a href='#' onclick='modif(".$conse.")'><img src='imagenes/editar.png' border='0' title='Modificar'></a></center></td><td height='35'><center>&nbsp;</center></td><td height='35'><center><a href='#' onclick='reinicio(".$reini.")'><img src='imagenes/reiniciar.png' border='0' title='Reiniciar Parametrizaci&oacute;n' width='24' height='24'></a></center></td><td height='35'><center>&nbsp;</center></td></tr>";
		}
		$i++;
	}
	$salida .= "</table>";
