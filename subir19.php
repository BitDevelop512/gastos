...
else
{
  ...
  $ruta_local1 = $ruta_local."\\upload\\rtm";
...
<div id="tabla">
  <table width="95%" align="center" border="1">
    <tr>
      <td colspan="2" bgcolor="#ccc"><center><b><font size="3" face="Verdana" color="#000000">Factura RTM Placa <?php echo $placa." - ".$sigla; ?></font></b></center></td>
    </tr>
    <tr>
      <td width="35%">
        <table width="100%" border="0" align="center">
          ...
          while (false !== ($file = readdir($dir)))
          {
            ...
            else
            {
              ...
              {
                $ruta = "./upload/rtm/".$placa."/".$sigla."/".$alea."/".$file;
                echo "<tr>";
                echo "<td width='90%'>";
...
$(document).ready(function() {
  $("#multipleupload").uploadFile({
    url: "upload19.php?alea=<?php echo $alea; ?>&sigla=<?php echo $sigla; ?>&placa=<?php echo $placa; ?>",
    multiple: false,
    dragDrop: true,
    fileName: "myfile",
