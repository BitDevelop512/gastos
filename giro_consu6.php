...
if (is_ajax())
{
    ...
    $query1 = "SELECT unidad, sigla, depen, n_depen, valor, total, uom, n_uom, conse FROM cx_val_aut2 WHERE conse IN ($con) AND periodo='$periodo' AND ano='$ano' AND ((estado='V' AND solicitud='0') OR (estado='' AND registro='0' AND pago='0')) AND inf_giro='0' ORDER BY unidad";
