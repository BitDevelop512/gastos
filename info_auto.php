...
$(document).ready(function () {
  ...
  $("#unidades2").select2.defaults.set("width", "100%");
  $("#unidades2").select2({
    tags: false,
    allowClear: false,
    closeOnSelect: true
  ...
  else
  {
    $.ajax({
      ...
      success: function (data)
      {
        ...
        salida1 += "<table width='100%' align='center' border='0'><tr><td height='35' width='5%'><b>No.</b></td><td height='35' width='10%'><b>Fecha</b></td><td height='35' width='10%'><b>Centralizadora</b></td><td height='35' width='10%'><b>Unidad</b></td><td height='35' width='8%'><b>Usuario</b></td><td height='35' width='9%'><b>Periodo</b></td><td height='35' width='12%' align='right'><b>Gastos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td height='35' width='12%' align='right'><b>Pagos&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td height='35' width='12%' align='right'><b>Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td><td height='35' width='4%'>&nbsp;</td></tr></table>";
        salida2 += "<table width='100%' align='center' border='0' id='a-table1'>";
        $.each(registros.rows, function (index, value)
        {
          var datos1 = '\"'+value.conse+'\",\"'+value.ano+'\",\"'+value.unidad+'\",\"'+value.unidad1+'\",\"'+value.periodo+'\",\"'+index+'\"';
          var valida2 = value.conse+","+value.unidad1+","+value.periodo+","+value.ano;
          ...
          salida2 += "<td height='35' width='10%' id='l4_"+index+"'>"+value.unidad2+"</td>";
          salida2 += "<td height='35' width='8%' id='l5_"+index+"'>"+value.usuario+"</td>";
          salida2 += "<td height='35' width='9%' id='l6_"+index+"'><center>"+value.periodo+" - "+value.ano+"</center></td>";
          salida2 += "<td height='35' width='12%' align='right' id='l7_"+index+"'>"+value.gastos+"</td>";
          salida2 += "<td height='35' width='12%' align='right' id='l8_"+index+"'>"+value.pagos+"</td>";
          salida2 += "<td height='35' width='12%' align='right' id='l9_"+index+"'>"+value.total+"</td>";
          if (tipo == "1")
          {
            salida2 += "<td height='35' width='4%' id='l10_"+index+"'><center><a href='#' onclick='javascript:highlightText2("+index+",12); link("+valida2+")'><img src='imagenes/pdf.png' border='0' title='Visualizar'></a></center></td>";
          }
          else
          {
          ...
          if (servidor == "C")
          {
            salida2 += "<td width='4%' height='35' id='l11_"+index+"'><center><img src='dist/img/server.png' width='25' height='25' border='0' title='Contingencia'></center></td>";
          }
          else
          {
...
function del_pdf(conse, ano, sigla, unidad, periodo, index)
{
  var conse, ano, sigla, unidad, periodo, index, archivo;
  archivo = "InfAut_"+unidad+"_"+conse+"_"+periodo+"_"+ano+".pdf";
  var ruta = "Autorizaciones\\"+ano+"\\"+archivo;
  $.ajax({
    type: "POST",
    datatype: "json",
    url: "borrar2.php",
...
// 06/05/2024 - Ajuste dialogos - Calendario contingencia
// 17/05/2024 - Ajuste consulta desde super usuario
// 20/05/2024 - Ajuste consulta por unidad centralizadora no unidad generada
// 20/05/2024 - Ajuste inclusion columnas de unidad centralizadora y periodo en consulta
// 10/10/2024 - Ajuste permiso administrador lista de unidades centralizadoras
// 22/11/2024 - Ajuste identificador contingencia
// 10/12/2024 - Ajuste pantalla confirmacion
// 29/04/2025 - Ajuste buscador campo unidad
?>