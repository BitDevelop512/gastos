...
else
{
	...
	$query = "SELECT fecha FROM cx_pla_inv WHERE conse='$conse' AND ano='$ano'";
	...
	else
	{
		if ($tipo == "1")
		{
			$pdf = "./".$fpdf."/638.php?conse=".$conse."&ano=".$ano."&ajuste=0";
		}
		else
		{
			$pdf = "./".$fpdf."/638_2.php?conse=".$conse."&ano=".$ano."&ajuste=0";
		}
	}
?>
<html lang="es">
