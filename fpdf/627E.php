...
else
{
	...
	$tit = "INFORME CONSOLIDADO DE EJECUCION MENSUAL DE GASTOS RESERVADOS   ".$sig_usuario."   Vigencia: ".$vigencia;
	...
	for ($clm=2;$clm<=16;$clm++) $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($clm, $fil, $tot[$clm-1]);
