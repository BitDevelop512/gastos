...
/* 631.php
   ...
   (pág 234 - "Dirtectiva Permanente No. 00095 de 2017.PDF")
	...
	- 27/12/2024 - Se ajusta el ancho de la columna No. para que no ocupe dos renglones cuando el número dle comprobante es mayor a 3. - Jorge Clavijo 	
*/
...
else
{
		...
		function morepagestable($datas, $lineheight=4)
		{
			...
			foreach($datas AS $row => $data)
			{
				...
				foreach($data AS $col => $txt)
				{
					...
					//ancho de columnas 5, 11, 9, 11, 11, 11, 12, 9, 18, 18, 18, 32, 106, 8
					...
					elseif ($this->tablewidths[$col] == 9) $this->MultiCell($this->tablewidths[$col],$lineheight,$txt,0,'C');					
	...
	$pdf->Cell(106,6,'Soporte',1,0,'C');
	$pdf->Cell(8,6,'Recurso',1,0,'C');
	$pdf->Cell(2,3,'',0,1,'C');
	$pdf->Cell(81,3,'emp recurso',0,1,'C');
	$pdf->SetFont('Arial','',5);
	$pdf->Cell(114,3,'SALDO ANTERIOR',0,0,'L');
	...
	$pdf->tablewidths = array(5, 11, 9, 11, 11, 11, 12, 9, 18, 18, 18, 32, 106, 8);	
