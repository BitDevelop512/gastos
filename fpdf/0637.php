...
else
{
	...
	//$n_ordena = "JAIME ALBERTO MORALES (CX)";
	...
	//Busca imagen de la firma
	//$n_visto = "JAIME ALBERTO MORALES (CX)";
	...
	$pdf->Cell(95,5,$c_ordena,0,0,'C');   //if ($tpu_usuario == "6") $pdf->Cell(95,5,$c_ordena,0,0,'C');   //'Jefe de Estado Mayor '.$sig_usuario
	//else $pdf->Cell(95,5,'Ordenador de Gastos Reservados '.$sig_usuario,0,0,'C');   //quitar ordenador y poner cargo
