...
else
{
	...
	function control_salto_pag($actual1)
	{
		global $pdf;
		$actual1=$actual1+5;
		if ($actual1>=162.00125)  //162.00125
		{
			$pdf->addpage();
		}
	} //control_salto_pag
	...
	//else $consulta = "select * from cv_pla_bie where unidad = '".$uni_usuario."' and convert(datetime,fec_com,102) BETWEEN convert(datetime,'".$_GET['fecha1']."',102) and (convert(datetime,'".$_GET['fecha2']."',102) + 1) order by conse";
