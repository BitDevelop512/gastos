...
else
{
	...
	$sigla = $_POST['comp_sig'];
 	// Archivo
 	if ($tipo == "1")
 	{
		$archivo = "CompIng_".trim($sigla)."_".$conse."_".$ano.".pdf";
	}
	else
 	{
 		$archivo = "CompEgr_".trim($sigla)."_".$conse."_".$ano.".pdf";
	}
...
// 22/04/2024 - Ajuste y retiro permiso de descarga
// 26/04/2024 - Eliminar pdf
?>
