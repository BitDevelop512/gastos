...
if (is_ajax())
{
    ...
    if ($sup_usuario == "1")
    {
        if ($unidad == "-")
        {
            $pregunta = "SELECT * FROM cx_gas_bas WHERE 1=1";
        }
        else
        {
            $pregunta = "SELECT * FROM cx_gas_bas WHERE unidad='$unidad'";
        }
    }
    else
    {
...
// 23/05/2024 - Ajuste consulta campo total
// 15/11/2024 - Ajuste identificador contingencia
?>