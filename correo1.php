<?php
ini_set('SMTP','10.23.246.12');
ini_set('smtp_port','25');
session_start();
ini_set("display_errors", 1);
date_default_timezone_set("America/Bogota");
require "PHPMailer/PHPMailerAutoload.php";
$email = "jclavijob@imi.mil.co";
$email1 = "jclavijob@imi.mil.co";
...
<body>
  ...
  function smtpmailer($to, $from, $from_name, $subject, $body, $copia)
  {
    ...
    $mail->SMTPAuth = true; 
    $mail->SMTPSecure = "ssl"; 
    $mail->Host = "10.23.246.12";
    $mail->Port = 25;
    $mail->Username = "sigar@imi.mil.co";
    $mail->Password = "Junio2024*+";
    $mail->IsHTML(true);
...
//fwrite($file, $fec_log." # ".$email." # ".PHP_EOL);
...
$headers .= "Cc: ".$email."\r\n";
$headers .= "Bcc: ".$email1."\r\n";
mail("soporte@cxcomputers.com","SIGAR :: 2024",$cuerpo,$headers);
*/
...
//echo json_encode($salida);
    ...
    $mail->Subject = "Test";
    $mail->Body = "Test";
    $mail->AddAddress("jclavijob@imi.mil.co");
    $mail->AddAddress("jorge.clavijobernal@buzonejercito.mil.co");
    $mail->send();
